	...
	.align	3
.LC0:
	.string	"%-6lu%c>0:x8=%d; 1:x8=%d; [x]=%d; [y]=%d;\n"
	.text
	.align	1
...
.L2:
	...
	.align	3
.LC1:
	.string	"SB+pos-pos, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"SB+pos-pos, global x unstabilized"
	.align	3
.LC6:
	.string	"SB+pos-pos, global y unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC11:
	...
	.align	3
.LC12:
	.string	"% Results for tests/non-mixed-size/RELAX/PodWR/SB+pos-pos.litmus %"
	.align	3
.LC13:
	.string	"RISCV SB+pos-pos"
	.align	3
.LC14:
	.string	"\"PosWW PodWR Fre PosWW PodWR Fre\""
	.align	3
.LC15:
	.string	"{"
	.align	3
...
.LC23:
	...
	.align	3
.LC24:
	.string	"exists ([x]=2 /\\ [y]=2 /\\ 0:x8=0 /\\ 1:x8=0)"
	.align	3
.LC25:
...
.LC38:
	...
	.align	3
.LC39:
	.string	"SB+pos-pos, sum_hist"
	.align	3
.LC40:
	.string	"Test SB+pos-pos Allowed\n"
	.align	3
.LC41:
	.string	"Histogram (%d states)\n"
	.align	3
.LC42:
	.string	"Observation SB+pos-pos %s %lu %lu\n"
	.align	3
.LC44:
	.string	"Time SB+pos-pos %.2f\n"
	.align	3
.LC45:
	.string	"Ok"
	.align	3
...
.LC48:
	...
	.align	3
.LC49:
	.string	"Hash=5a0791272abfb64e3aff01278f69b13c\n"
	.align	3
.LC50:
	.string	"Cycle=Fre PosWW PodWR Fre PosWW PodWR\n"
	.align	3
.LC51:
	.string	"PodWR"
	.align	3
.LC52:
	.string	"Relax SB+pos-pos %s %s\n"
	.align	3
.LC53:
...
.LC55:
	...
	.align	3
.LC56:
	.string	"Orig=PosWW PodWR Fre PosWW PodWR Fre\n"
	.align	3
.LC57:
	.string	"No"
	.align	3
...
.LC59:
	...
	.text
	.align	1
	.globl	SB_2B_pos_2D_pos
	.type	SB_2B_pos_2D_pos, @function
SB_2B_pos_2D_pos:
	addi	sp,sp,-528
	sd	s0,512(sp)
	sd	s1,504(sp)
...
.L240:
	call	__stack_chk_fail@plt
	.size	SB_2B_pos_2D_pos, .-SB_2B_pos_2D_pos
	.section	.rodata.str1.8
	.align	3
.LC60:
	.string	"[[0],[1]]"
