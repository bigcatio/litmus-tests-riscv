...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+poarp+po+NEW, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/AMO_X0_2_THREAD/MP+poarp+po+NEW.litmus %"
	.align	3
.LC10:
	.string	"RISCV MP+poarp+po+NEW"
	.align	3
.LC11:
	.string	"\"PodWWARP Rfe PodRR FrePAR\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC23:
	...
	.align	3
.LC24:
	.string	"MP+poarp+po+NEW: n=%i, r=%i, s=%i"
	.align	3
.LC25:
	.string	", st=%i"
	.align	3
...
.LC34:
	...
	.align	3
.LC35:
	.string	"MP+poarp+po+NEW, sum_hist"
	.align	3
.LC36:
	.string	"Test MP+poarp+po+NEW Allowed\n"
	.align	3
.LC37:
	.string	"Histogram (%d states)\n"
	.align	3
.LC38:
	.string	"Observation MP+poarp+po+NEW %s %lu %lu\n"
	.align	3
.LC40:
	.string	"Time MP+poarp+po+NEW %.2f\n"
	.align	3
.LC41:
	.string	"Ok"
	.align	3
...
.LC44:
	...
	.align	3
.LC45:
	.string	"Hash=a4e2a99b1db59cd0f11fef0a0898cbac\n"
	.align	3
.LC46:
	.string	"Cycle=Rfe PodRR FrePAR PodWWARP\n"
	.align	3
.LC47:
	.string	"AR"
	.align	3
.LC48:
	.string	"Relax MP+poarp+po+NEW %s %s\n"
	.align	3
.LC49:
...
.LC51:
	...
	.align	3
.LC52:
	.string	"Orig=PodWWARP Rfe PodRR FrePAR\n"
	.align	3
.LC53:
	.string	"No"
	.align	3
...
.LC55:
	...
	.text
	.align	1
	.globl	MP_2B_poarp_2B_po_2B_NEW
	.type	MP_2B_poarp_2B_po_2B_NEW, @function
MP_2B_poarp_2B_po_2B_NEW:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	MP_2B_poarp_2B_po_2B_NEW, .-MP_2B_poarp_2B_po_2B_NEW
	.section	.rodata.str1.8
	.align	3
.LC56:
	.string	"[[0],[1]]"
