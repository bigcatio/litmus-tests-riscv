...
.L2:
	...
	.align	3
.LC1:
	.string	"S+fence.i+data, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+fence.i+data, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/Fence.idWW/S+fence.i+data.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+fence.i+data"
	.align	3
.LC13:
	.string	"\"Fence.idWW Rfe DpDatadW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC27:
	...
	.align	3
.LC28:
	.string	"S+fence.i+data: n=%i, r=%i, s=%i"
	.align	3
.LC29:
	.string	", st=%i"
	.align	3
...
.LC38:
	...
	.align	3
.LC39:
	.string	"S+fence.i+data, sum_hist"
	.align	3
.LC40:
	.string	"Test S+fence.i+data Allowed\n"
	.align	3
.LC41:
	.string	"Histogram (%d states)\n"
	.align	3
.LC42:
	.string	"Observation S+fence.i+data %s %lu %lu\n"
	.align	3
.LC44:
	.string	"Time S+fence.i+data %.2f\n"
	.align	3
.LC45:
	.string	"Ok"
	.align	3
...
.LC48:
	...
	.align	3
.LC49:
	.string	"Hash=a8619fe49016316dcc86697d14ef8b71\n"
	.align	3
.LC50:
	.string	"Cycle=Rfe DpDatadW Wse Fence.idWW\n"
	.align	3
.LC51:
	.string	"Fence.idWW"
	.align	3
.LC52:
	.string	"Relax S+fence.i+data %s %s\n"
	.align	3
.LC53:
...
.LC55:
	...
	.align	3
.LC56:
	.string	"Orig=Fence.idWW Rfe DpDatadW Wse\n"
	.align	3
.LC57:
	.string	"No"
	.align	3
...
.LC59:
	...
	.text
	.align	1
	.globl	S_2B_fence_2E_i_2B_data
	.type	S_2B_fence_2E_i_2B_data, @function
S_2B_fence_2E_i_2B_data:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_fence_2E_i_2B_data, .-S_2B_fence_2E_i_2B_data
	.section	.rodata.str1.8
	.align	3
.LC60:
	.string	"[[0],[1]]"
