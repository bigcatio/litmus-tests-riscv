...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+po+fence.r.rw, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/PodWW/MP+po+fence.r.rw.litmus %"
	.align	3
.LC10:
	.string	"RISCV MP+po+fence.r.rw"
	.align	3
.LC11:
	.string	"\"PodWW Rfe Fence.r.rwdRR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC24:
	...
	.align	3
.LC25:
	.string	"MP+po+fence.r.rw: n=%i, r=%i, s=%i"
	.align	3
.LC26:
	.string	", st=%i"
	.align	3
...
.LC35:
	...
	.align	3
.LC36:
	.string	"MP+po+fence.r.rw, sum_hist"
	.align	3
.LC37:
	.string	"Test MP+po+fence.r.rw Allowed\n"
	.align	3
.LC38:
	.string	"Histogram (%d states)\n"
	.align	3
.LC39:
	.string	"Observation MP+po+fence.r.rw %s %lu %lu\n"
	.align	3
.LC41:
	.string	"Time MP+po+fence.r.rw %.2f\n"
	.align	3
.LC42:
	.string	"Ok"
	.align	3
...
.LC45:
	...
	.align	3
.LC46:
	.string	"Hash=ec3d28642a1d43b77fd7d35e75abab28\n"
	.align	3
.LC47:
	.string	"Cycle=Rfe Fence.r.rwdRR Fre PodWW\n"
	.align	3
.LC48:
	.string	"PodWW"
	.align	3
.LC49:
	.string	"Relax MP+po+fence.r.rw %s %s\n"
	.align	3
.LC50:
...
.LC52:
	...
	.align	3
.LC53:
	.string	"Orig=PodWW Rfe Fence.r.rwdRR Fre\n"
	.align	3
.LC54:
	.string	"No"
	.align	3
...
.LC56:
	...
	.text
	.align	1
	.globl	MP_2B_po_2B_fence_2E_r_2E_rw
	.type	MP_2B_po_2B_fence_2E_r_2E_rw, @function
MP_2B_po_2B_fence_2E_r_2E_rw:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	MP_2B_po_2B_fence_2E_r_2E_rw, .-MP_2B_po_2B_fence_2E_r_2E_rw
	.section	.rodata.str1.8
	.align	3
.LC57:
	.string	"[[0],[1]]"
