...
.L2:
	...
	.align	3
.LC1:
	.string	"S+po+fence.r.rw, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+po+fence.r.rw, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/PodWW/S+po+fence.r.rw.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+po+fence.r.rw"
	.align	3
.LC13:
	.string	"\"PodWW Rfe Fence.r.rwdRW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC26:
	...
	.align	3
.LC27:
	.string	"S+po+fence.r.rw: n=%i, r=%i, s=%i"
	.align	3
.LC28:
	.string	", st=%i"
	.align	3
...
.LC37:
	...
	.align	3
.LC38:
	.string	"S+po+fence.r.rw, sum_hist"
	.align	3
.LC39:
	.string	"Test S+po+fence.r.rw Allowed\n"
	.align	3
.LC40:
	.string	"Histogram (%d states)\n"
	.align	3
.LC41:
	.string	"Observation S+po+fence.r.rw %s %lu %lu\n"
	.align	3
.LC43:
	.string	"Time S+po+fence.r.rw %.2f\n"
	.align	3
.LC44:
	.string	"Ok"
	.align	3
...
.LC47:
	...
	.align	3
.LC48:
	.string	"Hash=299595b7b79245c2bc3c203fd802e28e\n"
	.align	3
.LC49:
	.string	"Cycle=Rfe Fence.r.rwdRW Wse PodWW\n"
	.align	3
.LC50:
	.string	"PodWW"
	.align	3
.LC51:
	.string	"Relax S+po+fence.r.rw %s %s\n"
	.align	3
.LC52:
...
.LC54:
	...
	.align	3
.LC55:
	.string	"Orig=PodWW Rfe Fence.r.rwdRW Wse\n"
	.align	3
.LC56:
	.string	"No"
	.align	3
...
.LC58:
	...
	.text
	.align	1
	.globl	S_2B_po_2B_fence_2E_r_2E_rw
	.type	S_2B_po_2B_fence_2E_r_2E_rw, @function
S_2B_po_2B_fence_2E_r_2E_rw:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_po_2B_fence_2E_r_2E_rw, .-S_2B_po_2B_fence_2E_r_2E_rw
	.section	.rodata.str1.8
	.align	3
.LC59:
	.string	"[[0],[1]]"
