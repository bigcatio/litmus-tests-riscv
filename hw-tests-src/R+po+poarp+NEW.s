...
.L2:
	...
	.align	3
.LC1:
	.string	"R+po+poarp+NEW, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"R+po+poarp+NEW, global y unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/AMO_X0_2_THREAD/R+po+poarp+NEW.litmus %"
	.align	3
.LC12:
	.string	"RISCV R+po+poarp+NEW"
	.align	3
.LC13:
	.string	"\"PodWW WsePAR PodWRARP Fre\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC25:
	...
	.align	3
.LC26:
	.string	"R+po+poarp+NEW: n=%i, r=%i, s=%i"
	.align	3
.LC27:
	.string	", st=%i"
	.align	3
...
.LC36:
	...
	.align	3
.LC37:
	.string	"R+po+poarp+NEW, sum_hist"
	.align	3
.LC38:
	.string	"Test R+po+poarp+NEW Allowed\n"
	.align	3
.LC39:
	.string	"Histogram (%d states)\n"
	.align	3
.LC40:
	.string	"Observation R+po+poarp+NEW %s %lu %lu\n"
	.align	3
.LC42:
	.string	"Time R+po+poarp+NEW %.2f\n"
	.align	3
.LC43:
	.string	"Ok"
	.align	3
...
.LC46:
	...
	.align	3
.LC47:
	.string	"Hash=e8cf2021c5682d20d46fe6ed5a502918\n"
	.align	3
.LC48:
	.string	"Cycle=Fre PodWW WsePAR PodWRARP\n"
	.align	3
.LC49:
	.string	"AR"
	.align	3
.LC50:
	.string	"Relax R+po+poarp+NEW %s %s\n"
	.align	3
.LC51:
...
.LC53:
	...
	.align	3
.LC54:
	.string	"Orig=PodWW WsePAR PodWRARP Fre\n"
	.align	3
.LC55:
	.string	"No"
	.align	3
...
.LC57:
	...
	.text
	.align	1
	.globl	R_2B_po_2B_poarp_2B_NEW
	.type	R_2B_po_2B_poarp_2B_NEW, @function
R_2B_po_2B_poarp_2B_NEW:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	R_2B_po_2B_poarp_2B_NEW, .-R_2B_po_2B_poarp_2B_NEW
	.section	.rodata.str1.8
	.align	3
.LC58:
	.string	"[[0],[1]]"
