...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+fence.rw.w+po, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/PodRR/MP+fence.rw.w+po.litmus %"
	.align	3
.LC10:
	.string	"RISCV MP+fence.rw.w+po"
	.align	3
.LC11:
	.string	"\"Fence.rw.wdWW Rfe PodRR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC24:
	...
	.align	3
.LC25:
	.string	"MP+fence.rw.w+po: n=%i, r=%i, s=%i"
	.align	3
.LC26:
	.string	", st=%i"
	.align	3
...
.LC35:
	...
	.align	3
.LC36:
	.string	"MP+fence.rw.w+po, sum_hist"
	.align	3
.LC37:
	.string	"Test MP+fence.rw.w+po Allowed\n"
	.align	3
.LC38:
	.string	"Histogram (%d states)\n"
	.align	3
.LC39:
	.string	"Observation MP+fence.rw.w+po %s %lu %lu\n"
	.align	3
.LC41:
	.string	"Time MP+fence.rw.w+po %.2f\n"
	.align	3
.LC42:
	.string	"Ok"
	.align	3
...
.LC45:
	...
	.align	3
.LC46:
	.string	"Hash=c120b52301d040f6c06b38673e7c9c6b\n"
	.align	3
.LC47:
	.string	"Cycle=Rfe PodRR Fre Fence.rw.wdWW\n"
	.align	3
.LC48:
	.string	"PodRR"
	.align	3
.LC49:
	.string	"Relax MP+fence.rw.w+po %s %s\n"
	.align	3
.LC50:
...
.LC52:
	...
	.align	3
.LC53:
	.string	"Orig=Fence.rw.wdWW Rfe PodRR Fre\n"
	.align	3
.LC54:
	.string	"No"
	.align	3
...
.LC56:
	...
	.text
	.align	1
	.globl	MP_2B_fence_2E_rw_2E_w_2B_po
	.type	MP_2B_fence_2E_rw_2E_w_2B_po, @function
MP_2B_fence_2E_rw_2E_w_2B_po:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	MP_2B_fence_2E_rw_2E_w_2B_po, .-MP_2B_fence_2E_rw_2E_w_2B_po
	.section	.rodata.str1.8
	.align	3
.LC57:
	.string	"[[0],[1]]"
