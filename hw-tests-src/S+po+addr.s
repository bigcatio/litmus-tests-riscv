...
.L2:
	...
	.align	3
.LC1:
	.string	"S+po+addr, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+po+addr, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/PodWW/S+po+addr.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+po+addr"
	.align	3
.LC13:
	.string	"\"PodWW Rfe DpAddrdW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC19:
	...
	.align	3
.LC20:
	.string	" sw x7,0(x8) | xor x7,x5,x5  ;"
	.align	3
.LC21:
...
.LC38:
	...
	.align	3
.LC39:
	.string	"S+po+addr, sum_hist"
	.align	3
.LC40:
	.string	"Test S+po+addr Allowed\n"
	.align	3
.LC41:
	.string	"Histogram (%d states)\n"
	.align	3
.LC42:
	.string	"Observation S+po+addr %s %lu %lu\n"
	.align	3
.LC44:
	.string	"Time S+po+addr %.2f\n"
	.align	3
.LC45:
	.string	"Ok"
	.align	3
...
.LC48:
	...
	.align	3
.LC49:
	.string	"Hash=51f05c4f5eb7d8156cd24e4492faff54\n"
	.align	3
.LC50:
	.string	"Cycle=Rfe DpAddrdW Wse PodWW\n"
	.align	3
.LC51:
	.string	"PodWW"
	.align	3
.LC52:
	.string	"Relax S+po+addr %s %s\n"
	.align	3
.LC53:
...
.LC55:
	...
	.align	3
.LC56:
	.string	"Orig=PodWW Rfe DpAddrdW Wse\n"
	.align	3
.LC57:
	.string	"No"
	.align	3
...
.LC59:
	...
	.text
	.align	1
	.globl	S_2B_po_2B_addr
	.type	S_2B_po_2B_addr, @function
S_2B_po_2B_addr:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_po_2B_addr, .-S_2B_po_2B_addr
	.section	.rodata.str1.8
	.align	3
.LC60:
	.string	"[[0],[1]]"
