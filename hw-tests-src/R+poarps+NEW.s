...
.L2:
	...
	.align	3
.LC1:
	.string	"R+poarps+NEW, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"R+poarps+NEW, global y unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/AMO_X0_2_THREAD/R+poarps+NEW.litmus %"
	.align	3
.LC12:
	.string	"RISCV R+poarps+NEW"
	.align	3
.LC13:
	.string	"\"PodWWARP WsePAR PodWRARP FrePAR\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC25:
	...
	.align	3
.LC26:
	.string	"R+poarps+NEW: n=%i, r=%i, s=%i"
	.align	3
.LC27:
	.string	", st=%i"
	.align	3
...
.LC36:
	...
	.align	3
.LC37:
	.string	"R+poarps+NEW, sum_hist"
	.align	3
.LC38:
	.string	"Test R+poarps+NEW Allowed\n"
	.align	3
.LC39:
	.string	"Histogram (%d states)\n"
	.align	3
.LC40:
	.string	"Observation R+poarps+NEW %s %lu %lu\n"
	.align	3
.LC42:
	.string	"Time R+poarps+NEW %.2f\n"
	.align	3
.LC43:
	.string	"Ok"
	.align	3
...
.LC46:
	...
	.align	3
.LC47:
	.string	"Hash=9c8217b062a7a2c5ed48903ebccc90ab\n"
	.align	3
.LC48:
	.string	"Cycle=FrePAR PodWWARP WsePAR PodWRARP\n"
	.align	3
.LC49:
	.string	"AR"
	.align	3
.LC50:
	.string	"Relax R+poarps+NEW %s %s\n"
	.align	3
.LC51:
...
.LC53:
	...
	.align	3
.LC54:
	.string	"Orig=PodWWARP WsePAR PodWRARP FrePAR\n"
	.align	3
.LC55:
	.string	"No"
	.align	3
...
.LC57:
	...
	.text
	.align	1
	.globl	R_2B_poarps_2B_NEW
	.type	R_2B_poarps_2B_NEW, @function
R_2B_poarps_2B_NEW:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	R_2B_poarps_2B_NEW, .-R_2B_poarps_2B_NEW
	.section	.rodata.str1.8
	.align	3
.LC58:
	.string	"[[0],[1]]"
