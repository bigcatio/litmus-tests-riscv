...
.L2:
	...
	.align	3
.LC1:
	.string	"3.2W+fence.w.ws, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"3.2W+fence.w.ws, global x unstabilized"
	.align	3
.LC6:
	.string	"3.2W+fence.w.ws, global y unstabilized"
	.align	3
.LC7:
	.string	"3.2W+fence.w.ws, global z unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC12:
	...
	.align	3
.LC13:
	.string	"% Results for tests/non-mixed-size/SAFE/3.2W+fence.w.ws.litmus %"
	.align	3
.LC14:
	.string	"RISCV 3.2W+fence.w.ws"
	.align	3
.LC15:
	.string	"\"Fence.w.wdWW Wse Fence.w.wdWW Wse Fence.w.wdWW Wse\""
	.align	3
.LC16:
	.string	"{"
	.align	3
...
.LC22:
	...
	.align	3
.LC23:
	.string	" fence w,w   | fence w,w   | fence w,w   ;"
	.align	3
.LC24:
...
.LC29:
	...
	.align	3
.LC30:
	.string	"3.2W+fence.w.ws: n=%i, r=%i, s=%i"
	.align	3
.LC31:
	.string	", st=%i"
	.align	3
...
.LC40:
	...
	.align	3
.LC41:
	.string	"3.2W+fence.w.ws, sum_hist"
	.align	3
.LC42:
	.string	"Test 3.2W+fence.w.ws Allowed\n"
	.align	3
.LC43:
	.string	"Histogram (%d states)\n"
	.align	3
.LC44:
	.string	"Observation 3.2W+fence.w.ws %s %lu %lu\n"
	.align	3
.LC46:
	.string	"Time 3.2W+fence.w.ws %.2f\n"
	.align	3
.LC47:
	.string	"Ok"
	.align	3
...
.LC50:
	...
	.align	3
.LC51:
	.string	"Hash=874f4541b5605a77f24f8dbca77ad7f9\n"
	.align	3
.LC52:
	.string	"Cycle=Wse Fence.w.wdWW Wse Fence.w.wdWW Wse Fence.w.wdWW\n"
	.align	3
.LC53:
	.string	"Relax 3.2W+fence.w.ws %s %s\n"
	.align	3
.LC54:
...
.LC56:
	...
	.align	3
.LC57:
	.string	"Orig=Fence.w.wdWW Wse Fence.w.wdWW Wse Fence.w.wdWW Wse\n"
	.align	3
.LC58:
	.string	"No"
	.align	3
...
.LC60:
	...
	.text
	.align	1
	.globl	_X3_2E_2W_2B_fence_2E_w_2E_ws
	.type	_X3_2E_2W_2B_fence_2E_w_2E_ws, @function
_X3_2E_2W_2B_fence_2E_w_2E_ws:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L282:
	call	__stack_chk_fail@plt
	.size	_X3_2E_2W_2B_fence_2E_w_2E_ws, .-_X3_2E_2W_2B_fence_2E_w_2E_ws
	.section	.rodata.str1.8
	.align	3
.LC61:
	.string	"[[1,2],[0]]"
