...
.L2:
	...
	.align	3
.LC1:
	.string	"S+fence.rw.rw+fence.i, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+fence.rw.rw+fence.i, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/Fence.idRW/S+fence.rw.rw+fence.i.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+fence.rw.rw+fence.i"
	.align	3
.LC13:
	.string	"\"Fence.rw.rwdWW Rfe Fence.idRW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC26:
	...
	.align	3
.LC27:
	.string	"S+fence.rw.rw+fence.i: n=%i, r=%i, s=%i"
	.align	3
.LC28:
	.string	", st=%i"
	.align	3
...
.LC37:
	...
	.align	3
.LC38:
	.string	"S+fence.rw.rw+fence.i, sum_hist"
	.align	3
.LC39:
	.string	"Test S+fence.rw.rw+fence.i Allowed\n"
	.align	3
.LC40:
	.string	"Histogram (%d states)\n"
	.align	3
.LC41:
	.string	"Observation S+fence.rw.rw+fence.i %s %lu %lu\n"
	.align	3
.LC43:
	.string	"Time S+fence.rw.rw+fence.i %.2f\n"
	.align	3
.LC44:
	.string	"Ok"
	.align	3
...
.LC47:
	...
	.align	3
.LC48:
	.string	"Hash=996e68cb6f4466b29ff2eaa695b0500d\n"
	.align	3
.LC49:
	.string	"Cycle=Rfe Fence.idRW Wse Fence.rw.rwdWW\n"
	.align	3
.LC50:
	.string	"Fence.idRW"
	.align	3
.LC51:
	.string	"Relax S+fence.rw.rw+fence.i %s %s\n"
	.align	3
.LC52:
...
.LC54:
	...
	.align	3
.LC55:
	.string	"Orig=Fence.rw.rwdWW Rfe Fence.idRW Wse\n"
	.align	3
.LC56:
	.string	"No"
	.align	3
...
.LC58:
	...
	.text
	.align	1
	.globl	S_2B_fence_2E_rw_2E_rw_2B_fence_2E_i
	.type	S_2B_fence_2E_rw_2E_rw_2B_fence_2E_i, @function
S_2B_fence_2E_rw_2E_rw_2B_fence_2E_i:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_fence_2E_rw_2E_rw_2B_fence_2E_i, .-S_2B_fence_2E_rw_2E_rw_2B_fence_2E_i
	.section	.rodata.str1.8
	.align	3
.LC59:
	.string	"[[0],[1]]"
