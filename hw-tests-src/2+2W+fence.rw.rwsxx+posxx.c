...
inline static int final_cond(int _out_0_x7,int _out_0_x8,int _out_0_x10,int _out_0_x11,int _out_1_x7,int _out_1_x8,int _out_1_x10,int _out_1_x11,int _x) {
  switch (_x) {
  case 0:
    switch (_out_0_x7) {
    case 0:
...
static const int out_0_x10_f = 2 ;
static const int out_0_x11_f = 3 ;
static const int out_1_x7_f = 4 ;
static const int out_1_x8_f = 5 ;
static const int out_1_x10_f = 6 ;
static const int out_1_x11_f = 7 ;
...
static void do_dump_outcome(FILE *fhist, intmax_t *o, count_t c, int show) {
  fprintf(fhist,"%-6"PCTR"%c>0:x7=%d; 0:x8=%d; 0:x10=%d; 0:x11=%d; 1:x7=%d; 1:x8=%d; 1:x10=%d; 1:x11=%d; [x]=%d;\n",c,show ? '*' : ':',(int)o[out_0_x7_f],(int)o[out_0_x8_f],(int)o[out_0_x10_f],(int)o[out_0_x11_f],(int)o[out_1_x7_f],(int)o[out_1_x8_f],(int)o[out_1_x10_f],(int)o[out_1_x11_f],(int)o[x_f]);
}
...
static void check_globals(ctx_t *_a) {
  ...
  for (int _i = _a->_p->size_of_test-1 ; _i >= 0 ; _i--) {
    if (rand_bit(&(_a->seed)) && x[_i] != 0) fatal("2+2W+fence.rw.rwsxx+posxx, check_globals failed");
  }
...
static void *P0(void *_vb) {
  ...
  force_one_affinity(_ecpu,AVAIL,_a->_p->verbose,"2+2W+fence.rw.rwsxx+posxx");
  check_globals(_a);
  int _th_id = _b->th_id;
...
"sc.w %[x11],%[x9],0(%[x5])\n"
"#END _litmus_P0\n"
:[x11] "=&r" (_a->out_0_x11[_i]),[x10] "=&r" (_a->out_0_x10[_i]),[x8] "=&r" (_a->out_0_x8[_i]),[x7] "=&r" (_a->out_0_x7[_i])
:[x5] "r" (&_a->x[_i]),[x6] "r" ((int)(1)),[x9] "r" ((int)(2))
:"cc","memory"
);
    }
  }
...
"sc.w %[x11],%[x9],0(%[x5])\n"
"#END _litmus_P1\n"
:[x11] "=&r" (_a->out_1_x11[_i]),[x10] "=&r" (_a->out_1_x10[_i]),[x8] "=&r" (_a->out_1_x8[_i]),[x7] "=&r" (_a->out_1_x7[_i])
...
static void init(ctx_t *_a) {
  ...
  _a->out_0_x10 = malloc_check(size_of_test*sizeof(*(_a->out_0_x10)));
  _a->out_0_x11 = malloc_check(size_of_test*sizeof(*(_a->out_0_x11)));
...
static void finalize(ctx_t *_a) {
  ...
  free((void *)_a->out_0_x10);
  free((void *)_a->out_0_x11);
...
static void reinit(ctx_t *_a) {
  for (int _i = _a->_p->size_of_test-1 ; _i >= 0 ; _i--) {
    ...
    _a->out_0_x10[_i] = -239487;
    _a->out_0_x11[_i] = -239487;
    _a->out_1_x7[_i] = -239487;
    _a->out_1_x8[_i] = -239487;
    _a->out_1_x10[_i] = -239487;
    _a->out_1_x11[_i] = -239487;
    _a->barrier[_i] = 0;
  }
}
...
static void *zyva(void *_va) {
  ...
  for (int n_run = 0 ; n_run < _b->max_run ; n_run++) {
    ...
    for (int _i = _b->size_of_test-1 ; _i >= 0 ; _i--) {
      ...
      int _out_0_x10_i = ctx.out_0_x10[_i];
      int _out_0_x11_i = ctx.out_0_x11[_i];
      ...
      for (int _p = N-1 ; _p >= 0 ; _p--) {
        if (_x_i != ctx.cpy_x[_p][_i]) fatal("2+2W+fence.rw.rwsxx+posxx, global x unstabilized") ;
      }
      cond = final_ok(final_cond(_out_0_x7_i,_out_0_x8_i,_out_0_x10_i,_out_0_x11_i,_out_1_x7_i,_out_1_x8_i,_out_1_x10_i,_out_1_x11_i,_x_i));
      o[out_0_x7_f] = _out_0_x7_i;
      o[out_0_x8_f] = _out_0_x8_i;
      o[out_0_x10_f] = _out_0_x10_i;
      o[out_0_x11_f] = _out_0_x11_i;
      o[out_1_x7_f] = _out_1_x7_i;
      o[out_1_x8_f] = _out_1_x8_i;
      o[out_1_x10_f] = _out_1_x10_i;
      o[out_1_x11_f] = _out_1_x11_i;
      o[x_f] = _x_i;
...
#else
#include "2+2W+fence.rw.rwsxx+posxx.h"
#endif
...
static int color_0[] = {1, -1};
static int color_1[] = {0, -1};
...
static void postlude(FILE *out,cmd_t *cmd,hist_t *hist,count_t p_true,count_t p_false,tsc_t total) {
  fprintf(out,"Test 2+2W+fence.rw.rwsxx+posxx Allowed\n");
  ...
  fprintf(out,"Condition %s is %svalidated\n","exists (not (0:x7=0 /\\ (0:x11=0 /\\ ([x]=2 /\\ (1:x11=1 /\\ (1:x8=1 /\\ (0:x10=1 /\\ 0:x8=0 /\\ (1:x10=2 /\\ (1:x7=0 \\/ 1:x7=1 \\/ 1:x7=2) \\/ 1:x10=1 /\\ (1:x7=1 \\/ 1:x7=0) \\/ 1:x10=0 /\\ 1:x7=0) \\/ 0:x10=0 /\\ 0:x8=1 /\\ (1:x10=2 /\\ (1:x7=2 \\/ 1:x7=0) \\/ 1:x10=0 /\\ 1:x7=0)) \\/ 0:x10=3 /\\ 1:x8=0 /\\ (0:x8=0 /\\ 1:x7=1 /\\ (1:x10=3 \\/ 1:x10=2) \\/ 0:x8=1 /\\ 1:x7=0 /\\ (1:x10=2 \\/ 1:x10=3))) \\/ 0:x10=4 /\\ 1:x11=0 /\\ (0:x8=0 /\\ (1:x10=1 /\\ 1:x8=1 /\\ (1:x7=1 \\/ 1:x7=0) \\/ 1:x10=3 /\\ 1:x7=1 /\\ 1:x8=0) \\/ 0:x8=1 /\\ 1:x7=0 /\\ (1:x10=0 /\\ 1:x8=1 \\/ 1:x10=3 /\\ 1:x8=0))) \\/ 1:x11=0 /\\ [x]=4 /\\ (1:x10=2 /\\ (1:x8=1 /\\ (0:x10=1 /\\ 0:x8=0 /\\ (1:x7=2 \\/ 1:x7=1 \\/ 1:x7=0) \\/ 0:x10=0 /\\ 0:x8=1 /\\ (1:x7=0 \\/ 1:x7=2)) \\/ 0:x10=3 /\\ 1:x8=0 /\\ (0:x8=0 /\\ 1:x7=1 \\/ 0:x8=1 /\\ 1:x7=0)) \\/ 1:x10=3 /\\ 1:x7=2 /\\ 1:x8=0 /\\ (0:x10=0 /\\ 0:x8=1 \\/ 0:x10=1 /\\ 0:x8=0)) \\/ 1:x10=3 /\\ 1:x11=1 /\\ 1:x7=2 /\\ 1:x8=0 /\\ [x]=3 /\\ (0:x10=0 /\\ 0:x8=1 \\/ 0:x10=1 /\\ 0:x8=0)) \\/ 0:x11=1 /\\ (0:x8=0 /\\ (1:x7=1 /\\ (1:x10=3 /\\ 1:x8=0 /\\ (1:x11=0 /\\ [x]=4 /\\ (0:x10=4 \\/ 0:x10=3 \\/ 0:x10=1) \\/ 1:x11=1 /\\ [x]=3 /\\ (0:x10=1 \\/ 0:x10=3)) \\/ 1:x10=1 /\\ 1:x8=1 /\\ (0:x10=1 /\\ (1:x11=0 /\\ [x]=4 \\/ 1:x11=1 /\\ [x]=1) \\/ 0:x10=4 /\\ 1:x11=0 /\\ [x]=4)) \\/ 1:x7=0 /\\ 1:x8=1 /\\ (0:x10=1 /\\ (1:x10=1 /\\ (1:x11=0 /\\ [x]=4 \\/ 1:x11=1 /\\ [x]=1) \\/ 1:x10=0 /\\ 1:x11=1 /\\ [x]=1) \\/ 0:x10=4 /\\ 1:x10=1 /\\ 1:x11=0 /\\ [x]=4)) \\/ 0:x8=1 /\\ 1:x7=0 /\\ (1:x10=3 /\\ 1:x8=0 /\\ (1:x11=0 /\\ [x]=4 /\\ (0:x10=0 \\/ 0:x10=3 \\/ 0:x10=4) \\/ 1:x11=1 /\\ [x]=3 /\\ (0:x10=3 \\/ 0:x10=0)) \\/ 1:x10=0 /\\ 1:x8=1 /\\ (0:x10=0 /\\ (1:x11=0 /\\ [x]=4 \\/ 1:x11=1 /\\ [x]=0) \\/ 0:x10=4 /\\ 1:x11=0 /\\ [x]=4)))) \\/ 1:x7=0 /\\ (1:x8=0 /\\ (0:x7=3 /\\ (0:x11=0 /\\ ([x]=2 /\\ (1:x11=1 /\\ (0:x10=1 /\\ 0:x8=0 /\\ (1:x10=3 \\/ 1:x10=2 \\/ 1:x10=1) \\/ 0:x10=3 /\\ 0:x8=1 /\\ (1:x10=2 \\/ 1:x10=3)) \\/ 0:x10=4 /\\ 1:x11=0 /\\ (0:x8=0 /\\ 1:x10=1 \\/ 0:x8=1 /\\ 1:x10=3)) \\/ 1:x10=2 /\\ 1:x11=0 /\\ [x]=4 /\\ (0:x10=1 /\\ 0:x8=0 \\/ 0:x10=3 /\\ 0:x8=1)) \\/ 0:x11=1 /\\ (0:x8=0 /\\ (0:x10=1 /\\ (1:x10=1 /\\ (1:x11=0 /\\ [x]=4 \\/ 1:x11=1 /\\ [x]=1) \\/ 1:x10=3 /\\ 1:x11=1 /\\ [x]=1) \\/ 0:x10=4 /\\ 1:x10=1 /\\ 1:x11=0 /\\ [x]=4) \\/ 0:x8=1 /\\ 1:x10=3 /\\ (0:x10=3 /\\ (1:x11=0 /\\ [x]=4 \\/ 1:x11=1 /\\ [x]=3) \\/ 0:x10=4 /\\ 1:x11=0 /\\ [x]=4))) \\/ 0:x7=4 /\\ 1:x10=3 /\\ 1:x11=0 /\\ (0:x10=1 /\\ 0:x8=0 /\\ (0:x11=0 /\\ [x]=2 \\/ 0:x11=1 /\\ [x]=1) \\/ 0:x10=4 /\\ 0:x8=1 /\\ (0:x11=0 /\\ [x]=2 \\/ 0:x11=1 /\\ [x]=4))) \\/ 0:x7=4 /\\ 1:x10=0 /\\ 1:x11=0 /\\ 1:x8=1 /\\ (0:x10=1 /\\ 0:x8=0 /\\ (0:x11=0 /\\ [x]=2 \\/ 0:x11=1 /\\ [x]=1) \\/ 0:x10=4 /\\ 0:x8=1 /\\ (0:x11=0 /\\ [x]=2 \\/ 0:x11=1 /\\ [x]=4)))))",cond ? "" : "NOT ");
  fprintf(out,"Hash=32000f88b932def90f33efd7b9608a4f\n");
  fprintf(out,"Cycle=WseXX PosWWXX WseXX Fence.rw.rwsWWXX\n");
  fprintf(out,"Relax 2+2W+fence.rw.rwsxx+posxx %s %s\n",p_true > 0 ? "Ok" : "No","WseXX");
  fprintf(out,"Safe=PosWW Fence.rw.rwsWW\n");
  fprintf(out,"Generator=diy7 (version 7.51+4(dev))\n");
  fprintf(out,"Com=Ws Ws\n");
  fprintf(out,"Orig=Fence.rw.rwsWWXX WseXX PosWWXX WseXX\n");
  if (cmd->aff_mode == aff_custom) {
    fprintf(out,"Affinity=[1] [0] ; \n");
  }
  count_t cond_true = p_true;
  count_t cond_false = p_false;
  fprintf(out,"Observation 2+2W+fence.rw.rwsxx+posxx %s %" PCTR " %" PCTR "\n",!cond_true ? "Never" : !cond_false ? "Always" : "Sometimes",cond_true,cond_false);
  fprintf(out,"Time 2+2W+fence.rw.rwsxx+posxx %.2f\n",total / 1000000.0);
  fflush(out);
}
...
/* Show parameters to user */
  if (prm.verbose) {
    log_error( "2+2W+fence.rw.rwsxx+posxx: n=%i, r=%i, s=%i",n_exe,prm.max_run,prm.size_of_test);
  ...
  for (int k=0 ; k < n_th ; k++) {
    ...
    if (sum_outs(hk->outcomes) != n_outs || hk->n_pos + hk->n_neg != n_outs) {
      fatal("2+2W+fence.rw.rwsxx+posxx, sum_hist");
    }
    merge_hists(hist,hk);
    free_hist(hk);
  }
...
int _X2_2B_2W_2B_fence_2E_rw_2E_rwsxx_2B_posxx(int argc, char **argv, FILE *out) {
