...
.L2:
	...
	.align	3
.LC1:
	.string	"R+porlps+NEW, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"R+porlps+NEW, global y unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/AMO_X0_2_THREAD/R+porlps+NEW.litmus %"
	.align	3
.LC12:
	.string	"RISCV R+porlps+NEW"
	.align	3
.LC13:
	.string	"\"PodWWRlP WsePRl PodWRRlP FrePRl\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC25:
	...
	.align	3
.LC26:
	.string	"R+porlps+NEW: n=%i, r=%i, s=%i"
	.align	3
.LC27:
	.string	", st=%i"
	.align	3
...
.LC36:
	...
	.align	3
.LC37:
	.string	"R+porlps+NEW, sum_hist"
	.align	3
.LC38:
	.string	"Test R+porlps+NEW Allowed\n"
	.align	3
.LC39:
	.string	"Histogram (%d states)\n"
	.align	3
.LC40:
	.string	"Observation R+porlps+NEW %s %lu %lu\n"
	.align	3
.LC42:
	.string	"Time R+porlps+NEW %.2f\n"
	.align	3
.LC43:
	.string	"Ok"
	.align	3
...
.LC46:
	...
	.align	3
.LC47:
	.string	"Hash=cfbeba605d3ee154efbfb9e2a1c67358\n"
	.align	3
.LC48:
	.string	"Cycle=FrePRl PodWWRlP WsePRl PodWRRlP\n"
	.align	3
.LC49:
	.string	"Rl"
	.align	3
.LC50:
	.string	"Relax R+porlps+NEW %s %s\n"
	.align	3
.LC51:
...
.LC53:
	...
	.align	3
.LC54:
	.string	"Orig=PodWWRlP WsePRl PodWRRlP FrePRl\n"
	.align	3
.LC55:
	.string	"No"
	.align	3
...
.LC57:
	...
	.text
	.align	1
	.globl	R_2B_porlps_2B_NEW
	.type	R_2B_porlps_2B_NEW, @function
R_2B_porlps_2B_NEW:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	R_2B_porlps_2B_NEW, .-R_2B_porlps_2B_NEW
	.section	.rodata.str1.8
	.align	3
.LC58:
	.string	"[[0],[1]]"
