...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+wsi-rfi-ctrl+addr, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"MP+wsi-rfi-ctrl+addr, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/Coi-Rfi/MP+wsi-rfi-ctrl+addr.litmus %"
	.align	3
.LC12:
	.string	"RISCV MP+wsi-rfi-ctrl+addr"
	.align	3
.LC13:
	.string	"\"Wsi Rfi DpCtrldW Rfe DpAddrdR Fre\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC29:
	...
	.align	3
.LC30:
	.string	"MP+wsi-rfi-ctrl+addr: n=%i, r=%i, s=%i"
	.align	3
.LC31:
	.string	", st=%i"
	.align	3
...
.LC40:
	...
	.align	3
.LC41:
	.string	"MP+wsi-rfi-ctrl+addr, sum_hist"
	.align	3
.LC42:
	.string	"Test MP+wsi-rfi-ctrl+addr Allowed\n"
	.align	3
.LC43:
	.string	"Histogram (%d states)\n"
	.align	3
.LC44:
	.string	"Observation MP+wsi-rfi-ctrl+addr %s %lu %lu\n"
	.align	3
.LC46:
	.string	"Time MP+wsi-rfi-ctrl+addr %.2f\n"
	.align	3
.LC47:
	.string	"Ok"
	.align	3
...
.LC51:
	...
	.align	3
.LC52:
	.string	"Cycle=Rfi DpCtrldW Rfe DpAddrdR Fre Wsi\n"
	.align	3
.LC53:
	.string	"[Wsi,Rfi]"
	.align	3
.LC54:
	.string	"Relax MP+wsi-rfi-ctrl+addr %s %s\n"
	.align	3
.LC55:
...
.LC57:
	...
	.align	3
.LC58:
	.string	"Orig=Wsi Rfi DpCtrldW Rfe DpAddrdR Fre\n"
	.align	3
.LC59:
	.string	"No"
	.align	3
...
.LC61:
	...
	.text
	.align	1
	.globl	MP_2B_wsi_2D_rfi_2D_ctrl_2B_addr
	.type	MP_2B_wsi_2D_rfi_2D_ctrl_2B_addr, @function
MP_2B_wsi_2D_rfi_2D_ctrl_2B_addr:
	addi	sp,sp,-528
	sd	s0,512(sp)
	sd	s1,504(sp)
	sd	s2,496(sp)
...
.L238:
	call	__stack_chk_fail@plt
	.size	MP_2B_wsi_2D_rfi_2D_ctrl_2B_addr, .-MP_2B_wsi_2D_rfi_2D_ctrl_2B_addr
	.section	.rodata.str1.8
	.align	3
.LC62:
	.string	"[[0],[1]]"
