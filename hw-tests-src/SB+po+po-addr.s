...
.L2:
	...
	.align	3
.LC1:
	.string	"SB+po+po-addr, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/PodWR/SB+po+po-addr.litmus %"
	.align	3
.LC10:
	.string	"RISCV SB+po+po-addr"
	.align	3
.LC11:
	.string	"\"PodWR Fre PodWR DpAddrdR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC26:
	...
	.align	3
.LC27:
	.string	"SB+po+po-addr: n=%i, r=%i, s=%i"
	.align	3
.LC28:
	.string	", st=%i"
	.align	3
...
.LC37:
	...
	.align	3
.LC38:
	.string	"SB+po+po-addr, sum_hist"
	.align	3
.LC39:
	.string	"Test SB+po+po-addr Allowed\n"
	.align	3
.LC40:
	.string	"Histogram (%d states)\n"
	.align	3
.LC41:
	.string	"Observation SB+po+po-addr %s %lu %lu\n"
	.align	3
.LC43:
	.string	"Time SB+po+po-addr %.2f\n"
	.align	3
.LC44:
	.string	"Ok"
	.align	3
...
.LC47:
	...
	.align	3
.LC48:
	.string	"Hash=44bdcbc192404c59370f8a436d0244cb\n"
	.align	3
.LC49:
	.string	"Cycle=Fre PodWR Fre PodWR DpAddrdR\n"
	.align	3
.LC50:
	.string	"PodWR"
	.align	3
.LC51:
	.string	"Relax SB+po+po-addr %s %s\n"
	.align	3
.LC52:
...
.LC54:
	...
	.align	3
.LC55:
	.string	"Orig=PodWR Fre PodWR DpAddrdR Fre\n"
	.align	3
.LC56:
	.string	"No"
	.align	3
...
.LC58:
	...
	.text
	.align	1
	.globl	SB_2B_po_2B_po_2D_addr
	.type	SB_2B_po_2B_po_2D_addr, @function
SB_2B_po_2B_po_2D_addr:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L223:
	call	__stack_chk_fail@plt
	.size	SB_2B_po_2B_po_2D_addr, .-SB_2B_po_2B_po_2D_addr
	.section	.rodata.str1.8
	.align	3
.LC59:
	.string	"[[0],[1]]"
