...
.L2:
	...
	.align	3
.LC1:
	.string	"LB+addr-rfi-addrs, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/Rfi/LB+addr-rfi-addrs.litmus %"
	.align	3
.LC10:
	.string	"RISCV LB+addr-rfi-addrs"
	.align	3
.LC11:
	.string	"\"DpAddrdW Rfi DpAddrdW Rfe DpAddrdW Rfi DpAddrdW Rfe\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC22:
	...
	.align	3
.LC23:
	.string	" add x14,x13,x12 | add x14,x13,x12 ;"
	.align	3
.LC24:
	.string	" sw x8,0(x14)    | sw x8,0(x14)    ;"
	.align	3
.LC25:
	.string	""
	.align	3
...
.LC29:
	...
	.align	3
.LC30:
	.string	"LB+addr-rfi-addrs: n=%i, r=%i, s=%i"
	.align	3
.LC31:
	.string	", st=%i"
	.align	3
...
.LC40:
	...
	.align	3
.LC41:
	.string	"LB+addr-rfi-addrs, sum_hist"
	.align	3
.LC42:
	.string	"Test LB+addr-rfi-addrs Allowed\n"
	.align	3
.LC43:
	.string	"Histogram (%d states)\n"
	.align	3
.LC44:
	.string	"Observation LB+addr-rfi-addrs %s %lu %lu\n"
	.align	3
.LC46:
	.string	"Time LB+addr-rfi-addrs %.2f\n"
	.align	3
.LC47:
	.string	"Ok"
	.align	3
...
.LC50:
	...
	.align	3
.LC51:
	.string	"Hash=1b6e4898f1c3910b7c04e67db1b1279f\n"
	.align	3
.LC52:
	.string	"Cycle=Rfi DpAddrdW Rfe DpAddrdW Rfi DpAddrdW Rfe DpAddrdW\n"
	.align	3
.LC53:
	.string	"Rfi"
	.align	3
.LC54:
	.string	"Relax LB+addr-rfi-addrs %s %s\n"
	.align	3
.LC55:
...
.LC57:
	...
	.align	3
.LC58:
	.string	"Orig=DpAddrdW Rfi DpAddrdW Rfe DpAddrdW Rfi DpAddrdW Rfe\n"
	.align	3
.LC59:
	.string	"No"
	.align	3
...
.LC61:
	...
	.text
	.align	1
	.globl	LB_2B_addr_2D_rfi_2D_addrs
	.type	LB_2B_addr_2D_rfi_2D_addrs, @function
LB_2B_addr_2D_rfi_2D_addrs:
	addi	sp,sp,-528
	sd	s0,512(sp)
	sd	s1,504(sp)
	sd	s2,496(sp)
...
.L235:
	call	__stack_chk_fail@plt
	.size	LB_2B_addr_2D_rfi_2D_addrs, .-LB_2B_addr_2D_rfi_2D_addrs
	.section	.rodata.str1.8
	.align	3
.LC62:
	.string	"[[0],[1]]"
