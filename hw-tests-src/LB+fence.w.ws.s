...
.L2:
	...
	.align	3
.LC1:
	.string	"LB+fence.w.ws, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/Fence.w.wdRW/LB+fence.w.ws.litmus %"
	.align	3
.LC10:
	.string	"RISCV LB+fence.w.ws"
	.align	3
.LC11:
	.string	"\"Fence.w.wdRW Rfe Fence.w.wdRW Rfe\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC24:
	...
	.align	3
.LC25:
	.string	"LB+fence.w.ws: n=%i, r=%i, s=%i"
	.align	3
.LC26:
	.string	", st=%i"
	.align	3
...
.LC35:
	...
	.align	3
.LC36:
	.string	"LB+fence.w.ws, sum_hist"
	.align	3
.LC37:
	.string	"Test LB+fence.w.ws Allowed\n"
	.align	3
.LC38:
	.string	"Histogram (%d states)\n"
	.align	3
.LC39:
	.string	"Observation LB+fence.w.ws %s %lu %lu\n"
	.align	3
.LC41:
	.string	"Time LB+fence.w.ws %.2f\n"
	.align	3
.LC42:
	.string	"Ok"
	.align	3
...
.LC45:
	...
	.align	3
.LC46:
	.string	"Hash=92f66eecd2702c8f57935df21405f596\n"
	.align	3
.LC47:
	.string	"Cycle=Rfe Fence.w.wdRW Rfe Fence.w.wdRW\n"
	.align	3
.LC48:
	.string	"Fence.w.wdRW"
	.align	3
.LC49:
	.string	"Relax LB+fence.w.ws %s %s\n"
	.align	3
.LC50:
	.string	"Safe=Rfe\n"
	.align	3
...
.LC52:
	...
	.align	3
.LC53:
	.string	"Orig=Fence.w.wdRW Rfe Fence.w.wdRW Rfe\n"
	.align	3
.LC54:
	.string	"No"
	.align	3
...
.LC56:
	...
	.text
	.align	1
	.globl	LB_2B_fence_2E_w_2E_ws
	.type	LB_2B_fence_2E_w_2E_ws, @function
LB_2B_fence_2E_w_2E_ws:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	LB_2B_fence_2E_w_2E_ws, .-LB_2B_fence_2E_w_2E_ws
	.section	.rodata.str1.8
	.align	3
.LC57:
	.string	"[[0],[1]]"
