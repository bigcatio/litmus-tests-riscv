...
.L2:
	...
	.align	3
.LC1:
	.string	"2+2W+fence.r.rws, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"2+2W+fence.r.rws, global x unstabilized"
	.align	3
.LC6:
	.string	"2+2W+fence.r.rws, global y unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC11:
	...
	.align	3
.LC12:
	.string	"% Results for tests/non-mixed-size/RELAX/Fence.r.rwdWW/2+2W+fence.r.rws.litmus %"
	.align	3
.LC13:
	.string	"RISCV 2+2W+fence.r.rws"
	.align	3
.LC14:
	.string	"\"Fence.r.rwdWW Wse Fence.r.rwdWW Wse\""
	.align	3
.LC15:
	.string	"{"
	.align	3
...
.LC27:
	...
	.align	3
.LC28:
	.string	"2+2W+fence.r.rws: n=%i, r=%i, s=%i"
	.align	3
.LC29:
	.string	", st=%i"
	.align	3
...
.LC38:
	...
	.align	3
.LC39:
	.string	"2+2W+fence.r.rws, sum_hist"
	.align	3
.LC40:
	.string	"Test 2+2W+fence.r.rws Allowed\n"
	.align	3
.LC41:
	.string	"Histogram (%d states)\n"
	.align	3
.LC42:
	.string	"Observation 2+2W+fence.r.rws %s %lu %lu\n"
	.align	3
.LC44:
	.string	"Time 2+2W+fence.r.rws %.2f\n"
	.align	3
.LC45:
	.string	"Ok"
	.align	3
...
.LC48:
	...
	.align	3
.LC49:
	.string	"Hash=c80d7cac9c074d1688b14a12403152ad\n"
	.align	3
.LC50:
	.string	"Cycle=Wse Fence.r.rwdWW Wse Fence.r.rwdWW\n"
	.align	3
.LC51:
	.string	"Fence.r.rwdWW"
	.align	3
.LC52:
	.string	"Relax 2+2W+fence.r.rws %s %s\n"
	.align	3
.LC53:
	.string	"Safe=Wse\n"
	.align	3
...
.LC55:
	...
	.align	3
.LC56:
	.string	"Orig=Fence.r.rwdWW Wse Fence.r.rwdWW Wse\n"
	.align	3
.LC57:
	.string	"No"
	.align	3
...
.LC59:
	...
	.text
	.align	1
	.globl	_X2_2B_2W_2B_fence_2E_r_2E_rws
	.type	_X2_2B_2W_2B_fence_2E_r_2E_rws, @function
_X2_2B_2W_2B_fence_2E_r_2E_rws:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L236:
	call	__stack_chk_fail@plt
	.size	_X2_2B_2W_2B_fence_2E_r_2E_rws, .-_X2_2B_2W_2B_fence_2E_r_2E_rws
	.section	.rodata.str1.8
	.align	3
.LC60:
	.string	"[[0],[1]]"
