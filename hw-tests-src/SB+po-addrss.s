...
.L2:
	...
	.align	3
.LC1:
	.string	"SB+po-addrss, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/PodWR/SB+po-addrss.litmus %"
	.align	3
.LC10:
	.string	"RISCV SB+po-addrss"
	.align	3
.LC11:
	.string	"\"PodWR DpAddrsR Fre PodWR DpAddrsR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC19:
	...
	.align	3
.LC20:
	.string	" add x11,x8,x9 | add x11,x8,x9 ;"
	.align	3
.LC21:
...
.LC26:
	...
	.align	3
.LC27:
	.string	"SB+po-addrss: n=%i, r=%i, s=%i"
	.align	3
.LC28:
	.string	", st=%i"
	.align	3
...
.LC37:
	...
	.align	3
.LC38:
	.string	"SB+po-addrss, sum_hist"
	.align	3
.LC39:
	.string	"Test SB+po-addrss Allowed\n"
	.align	3
.LC40:
	.string	"Histogram (%d states)\n"
	.align	3
.LC41:
	.string	"Observation SB+po-addrss %s %lu %lu\n"
	.align	3
.LC43:
	.string	"Time SB+po-addrss %.2f\n"
	.align	3
.LC44:
	.string	"Ok"
	.align	3
...
.LC47:
	...
	.align	3
.LC48:
	.string	"Hash=e926ea2a9acf8996334b61a03b9ebc14\n"
	.align	3
.LC49:
	.string	"Cycle=Fre PodWR DpAddrsR Fre PodWR DpAddrsR\n"
	.align	3
.LC50:
	.string	"PodWR"
	.align	3
.LC51:
	.string	"Relax SB+po-addrss %s %s\n"
	.align	3
.LC52:
...
.LC54:
	...
	.align	3
.LC55:
	.string	"Orig=PodWR DpAddrsR Fre PodWR DpAddrsR Fre\n"
	.align	3
.LC56:
	.string	"No"
	.align	3
...
.LC58:
	...
	.text
	.align	1
	.globl	SB_2B_po_2D_addrss
	.type	SB_2B_po_2D_addrss, @function
SB_2B_po_2D_addrss:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	SB_2B_po_2D_addrss, .-SB_2B_po_2D_addrss
	.section	.rodata.str1.8
	.align	3
.LC59:
	.string	"[[0],[1]]"
