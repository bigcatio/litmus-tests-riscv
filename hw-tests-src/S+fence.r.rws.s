...
.L2:
	...
	.align	3
.LC1:
	.string	"S+fence.r.rws, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+fence.r.rws, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/Fence.r.rwdWW/S+fence.r.rws.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+fence.r.rws"
	.align	3
.LC13:
	.string	"\"Fence.r.rwdWW Rfe Fence.r.rwdRW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC26:
	...
	.align	3
.LC27:
	.string	"S+fence.r.rws: n=%i, r=%i, s=%i"
	.align	3
.LC28:
	.string	", st=%i"
	.align	3
...
.LC37:
	...
	.align	3
.LC38:
	.string	"S+fence.r.rws, sum_hist"
	.align	3
.LC39:
	.string	"Test S+fence.r.rws Allowed\n"
	.align	3
.LC40:
	.string	"Histogram (%d states)\n"
	.align	3
.LC41:
	.string	"Observation S+fence.r.rws %s %lu %lu\n"
	.align	3
.LC43:
	.string	"Time S+fence.r.rws %.2f\n"
	.align	3
.LC44:
	.string	"Ok"
	.align	3
...
.LC47:
	...
	.align	3
.LC48:
	.string	"Hash=0830f70397d20b275a5441b10a172165\n"
	.align	3
.LC49:
	.string	"Cycle=Rfe Fence.r.rwdRW Wse Fence.r.rwdWW\n"
	.align	3
.LC50:
	.string	"Fence.r.rwdWW"
	.align	3
.LC51:
	.string	"Relax S+fence.r.rws %s %s\n"
	.align	3
.LC52:
...
.LC54:
	...
	.align	3
.LC55:
	.string	"Orig=Fence.r.rwdWW Rfe Fence.r.rwdRW Wse\n"
	.align	3
.LC56:
	.string	"No"
	.align	3
...
.LC58:
	...
	.text
	.align	1
	.globl	S_2B_fence_2E_r_2E_rws
	.type	S_2B_fence_2E_r_2E_rws, @function
S_2B_fence_2E_r_2E_rws:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_fence_2E_r_2E_rws, .-S_2B_fence_2E_r_2E_rws
	.section	.rodata.str1.8
	.align	3
.LC59:
	.string	"[[0],[1]]"
