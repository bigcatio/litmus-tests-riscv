...
.L2:
	...
	.align	3
.LC1:
	.string	"LB+popars+NEW, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/AMO_X0_2_THREAD/LB+popars+NEW.litmus %"
	.align	3
.LC10:
	.string	"RISCV LB+popars+NEW"
	.align	3
.LC11:
	.string	"\"PodRWPAR RfeARP PodRWPAR RfeARP\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC23:
	...
	.align	3
.LC24:
	.string	"LB+popars+NEW: n=%i, r=%i, s=%i"
	.align	3
.LC25:
	.string	", st=%i"
	.align	3
...
.LC34:
	...
	.align	3
.LC35:
	.string	"LB+popars+NEW, sum_hist"
	.align	3
.LC36:
	.string	"Test LB+popars+NEW Allowed\n"
	.align	3
.LC37:
	.string	"Histogram (%d states)\n"
	.align	3
.LC38:
	.string	"Observation LB+popars+NEW %s %lu %lu\n"
	.align	3
.LC40:
	.string	"Time LB+popars+NEW %.2f\n"
	.align	3
.LC41:
	.string	"Ok"
	.align	3
...
.LC44:
	...
	.align	3
.LC45:
	.string	"Hash=8c752df55da653eaef6ca808e024eed3\n"
	.align	3
.LC46:
	.string	"Cycle=PodRWPAR RfeARP PodRWPAR RfeARP\n"
	.align	3
.LC47:
	.string	"AR"
	.align	3
.LC48:
	.string	"Relax LB+popars+NEW %s %s\n"
	.align	3
.LC49:
...
.LC51:
	...
	.align	3
.LC52:
	.string	"Orig=PodRWPAR RfeARP PodRWPAR RfeARP\n"
	.align	3
.LC53:
	.string	"No"
	.align	3
...
.LC55:
	...
	.text
	.align	1
	.globl	LB_2B_popars_2B_NEW
	.type	LB_2B_popars_2B_NEW, @function
LB_2B_popars_2B_NEW:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	LB_2B_popars_2B_NEW, .-LB_2B_popars_2B_NEW
	.section	.rodata.str1.8
	.align	3
.LC56:
	.string	"[[0],[1]]"
