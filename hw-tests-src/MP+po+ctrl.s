...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+po+ctrl, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/BASIC_2_THREAD/MP+po+ctrl.litmus %"
	.align	3
.LC10:
	.string	"RISCV MP+po+ctrl"
	.align	3
.LC11:
	.string	"\"PodWW Rfe DpCtrldR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC36:
	...
	.align	3
.LC37:
	.string	"MP+po+ctrl, sum_hist"
	.align	3
.LC38:
	.string	"Test MP+po+ctrl Allowed\n"
	.align	3
.LC39:
	.string	"Histogram (%d states)\n"
	.align	3
.LC40:
	.string	"Observation MP+po+ctrl %s %lu %lu\n"
	.align	3
.LC42:
	.string	"Time MP+po+ctrl %.2f\n"
	.align	3
.LC43:
	.string	"Ok"
	.align	3
...
.LC46:
	...
	.align	3
.LC47:
	.string	"Hash=b87211810e0e589e410e05c78c203c57\n"
	.align	3
.LC48:
	.string	"Cycle=Rfe DpCtrldR Fre PodWW\n"
	.align	3
.LC49:
	.string	"Relax MP+po+ctrl %s %s\n"
	.align	3
.LC50:
	.string	"Safe=Rfe Fre PodWW DpCtrldR\n"
	.align	3
.LC51:
...
.LC52:
	...
	.align	3
.LC53:
	.string	"Orig=PodWW Rfe DpCtrldR Fre\n"
	.align	3
.LC54:
	.string	"No"
	.align	3
...
.LC56:
	...
	.text
	.align	1
	.globl	MP_2B_po_2B_ctrl
	.type	MP_2B_po_2B_ctrl, @function
MP_2B_po_2B_ctrl:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	MP_2B_po_2B_ctrl, .-MP_2B_po_2B_ctrl
	.section	.rodata.str1.8
	.align	3
.LC57:
	.string	"[[0],[1]]"
