...
.L2:
	...
	.align	3
.LC1:
	.string	"R+fence.rw.rws, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"R+fence.rw.rws, global y unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/SAFE/R+fence.rw.rws.litmus %"
	.align	3
.LC12:
	.string	"RISCV R+fence.rw.rws"
	.align	3
.LC13:
	.string	"\"Fence.rw.rwdWW Wse Fence.rw.rwdWR Fre\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC26:
	...
	.align	3
.LC27:
	.string	"R+fence.rw.rws: n=%i, r=%i, s=%i"
	.align	3
.LC28:
	.string	", st=%i"
	.align	3
...
.LC37:
	...
	.align	3
.LC38:
	.string	"R+fence.rw.rws, sum_hist"
	.align	3
.LC39:
	.string	"Test R+fence.rw.rws Allowed\n"
	.align	3
.LC40:
	.string	"Histogram (%d states)\n"
	.align	3
.LC41:
	.string	"Observation R+fence.rw.rws %s %lu %lu\n"
	.align	3
.LC43:
	.string	"Time R+fence.rw.rws %.2f\n"
	.align	3
.LC44:
	.string	"Ok"
	.align	3
...
.LC47:
	...
	.align	3
.LC48:
	.string	"Hash=0fa9ecc913dd7df15bbcf80a989e70b5\n"
	.align	3
.LC49:
	.string	"Cycle=Fre Fence.rw.rwdWW Wse Fence.rw.rwdWR\n"
	.align	3
.LC50:
	.string	"Relax R+fence.rw.rws %s %s\n"
	.align	3
.LC51:
...
.LC53:
	...
	.align	3
.LC54:
	.string	"Orig=Fence.rw.rwdWW Wse Fence.rw.rwdWR Fre\n"
	.align	3
.LC55:
	.string	"No"
	.align	3
...
.LC57:
	...
	.text
	.align	1
	.globl	R_2B_fence_2E_rw_2E_rws
	.type	R_2B_fence_2E_rw_2E_rws, @function
R_2B_fence_2E_rw_2E_rws:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	R_2B_fence_2E_rw_2E_rws, .-R_2B_fence_2E_rw_2E_rws
	.section	.rodata.str1.8
	.align	3
.LC58:
	.string	"[[0],[1]]"
