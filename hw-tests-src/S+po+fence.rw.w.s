...
.L2:
	...
	.align	3
.LC1:
	.string	"S+po+fence.rw.w, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+po+fence.rw.w, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/PodWW/S+po+fence.rw.w.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+po+fence.rw.w"
	.align	3
.LC13:
	.string	"\"PodWW Rfe Fence.rw.wdRW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC26:
	...
	.align	3
.LC27:
	.string	"S+po+fence.rw.w: n=%i, r=%i, s=%i"
	.align	3
.LC28:
	.string	", st=%i"
	.align	3
...
.LC37:
	...
	.align	3
.LC38:
	.string	"S+po+fence.rw.w, sum_hist"
	.align	3
.LC39:
	.string	"Test S+po+fence.rw.w Allowed\n"
	.align	3
.LC40:
	.string	"Histogram (%d states)\n"
	.align	3
.LC41:
	.string	"Observation S+po+fence.rw.w %s %lu %lu\n"
	.align	3
.LC43:
	.string	"Time S+po+fence.rw.w %.2f\n"
	.align	3
.LC44:
	.string	"Ok"
	.align	3
...
.LC47:
	...
	.align	3
.LC48:
	.string	"Hash=fd7fc6625a6a1c45e68dc7831466de19\n"
	.align	3
.LC49:
	.string	"Cycle=Rfe Fence.rw.wdRW Wse PodWW\n"
	.align	3
.LC50:
	.string	"PodWW"
	.align	3
.LC51:
	.string	"Relax S+po+fence.rw.w %s %s\n"
	.align	3
.LC52:
...
.LC54:
	...
	.align	3
.LC55:
	.string	"Orig=PodWW Rfe Fence.rw.wdRW Wse\n"
	.align	3
.LC56:
	.string	"No"
	.align	3
...
.LC58:
	...
	.text
	.align	1
	.globl	S_2B_po_2B_fence_2E_rw_2E_w
	.type	S_2B_po_2B_fence_2E_rw_2E_w, @function
S_2B_po_2B_fence_2E_rw_2E_w:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_po_2B_fence_2E_rw_2E_w, .-S_2B_po_2B_fence_2E_rw_2E_w
	.section	.rodata.str1.8
	.align	3
.LC59:
	.string	"[[0],[1]]"
