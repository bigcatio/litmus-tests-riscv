...
.L2:
	...
	.align	3
.LC1:
	.string	"LB+fence.tsos, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/FENCE.TSO/2/LB+fence.tsos.litmus %"
	.align	3
.LC10:
	.string	"RISCV LB+fence.tsos"
	.align	3
.LC11:
	.string	"\"Fence.tsodRW Rfe Fence.tsodRW Rfe\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC24:
	...
	.align	3
.LC25:
	.string	"LB+fence.tsos: n=%i, r=%i, s=%i"
	.align	3
.LC26:
	.string	", st=%i"
	.align	3
...
.LC35:
	...
	.align	3
.LC36:
	.string	"LB+fence.tsos, sum_hist"
	.align	3
.LC37:
	.string	"Test LB+fence.tsos Allowed\n"
	.align	3
.LC38:
	.string	"Histogram (%d states)\n"
	.align	3
.LC39:
	.string	"Observation LB+fence.tsos %s %lu %lu\n"
	.align	3
.LC41:
	.string	"Time LB+fence.tsos %.2f\n"
	.align	3
.LC42:
	.string	"Ok"
	.align	3
...
.LC45:
	...
	.align	3
.LC46:
	.string	"Hash=39e01e116eda6cf63d6a06f84a97c4e4\n"
	.align	3
.LC47:
	.string	"Cycle=Rfe Fence.tsodRW Rfe Fence.tsodRW\n"
	.align	3
.LC48:
	.string	"Relax LB+fence.tsos %s %s\n"
	.align	3
.LC49:
	.string	"Safe=Rfe Fence.tsodRW\n"
	.align	3
.LC50:
...
.LC51:
	...
	.align	3
.LC52:
	.string	"Orig=Fence.tsodRW Rfe Fence.tsodRW Rfe\n"
	.align	3
.LC53:
	.string	"No"
	.align	3
...
.LC55:
	...
	.text
	.align	1
	.globl	LB_2B_fence_2E_tsos
	.type	LB_2B_fence_2E_tsos, @function
LB_2B_fence_2E_tsos:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	LB_2B_fence_2E_tsos, .-LB_2B_fence_2E_tsos
	.section	.rodata.str1.8
	.align	3
.LC56:
	.string	"[[0],[1]]"
