...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+poarars+NEW, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/AMO_X0_2_THREAD/MP+poarars+NEW.litmus %"
	.align	3
.LC10:
	.string	"RISCV MP+poarars+NEW"
	.align	3
.LC11:
	.string	"\"PodWWARAR RfeARAR PodRRARAR FreARAR\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC23:
	...
	.align	3
.LC24:
	.string	"MP+poarars+NEW: n=%i, r=%i, s=%i"
	.align	3
.LC25:
	.string	", st=%i"
	.align	3
...
.LC34:
	...
	.align	3
.LC35:
	.string	"MP+poarars+NEW, sum_hist"
	.align	3
.LC36:
	.string	"Test MP+poarars+NEW Allowed\n"
	.align	3
.LC37:
	.string	"Histogram (%d states)\n"
	.align	3
.LC38:
	.string	"Observation MP+poarars+NEW %s %lu %lu\n"
	.align	3
.LC40:
	.string	"Time MP+poarars+NEW %.2f\n"
	.align	3
.LC41:
	.string	"Ok"
	.align	3
...
.LC44:
	...
	.align	3
.LC45:
	.string	"Hash=96a324f160f4908f4718fb1e036f716c\n"
	.align	3
.LC46:
	.string	"Cycle=RfeARAR PodRRARAR FreARAR PodWWARAR\n"
	.align	3
.LC47:
	.string	"AR"
	.align	3
.LC48:
	.string	"Relax MP+poarars+NEW %s %s\n"
	.align	3
.LC49:
...
.LC51:
	...
	.align	3
.LC52:
	.string	"Orig=PodWWARAR RfeARAR PodRRARAR FreARAR\n"
	.align	3
.LC53:
	.string	"No"
	.align	3
...
.LC55:
	...
	.text
	.align	1
	.globl	MP_2B_poarars_2B_NEW
	.type	MP_2B_poarars_2B_NEW, @function
MP_2B_poarars_2B_NEW:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	MP_2B_poarars_2B_NEW, .-MP_2B_poarars_2B_NEW
	.section	.rodata.str1.8
	.align	3
.LC56:
	.string	"[[0],[1]]"
