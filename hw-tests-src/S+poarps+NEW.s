...
.L2:
	...
	.align	3
.LC1:
	.string	"S+poarps+NEW, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+poarps+NEW, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/AMO_X0_2_THREAD/S+poarps+NEW.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+poarps+NEW"
	.align	3
.LC13:
	.string	"\"PodWWARP RfePAR PodRWARP WsePAR\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC25:
	...
	.align	3
.LC26:
	.string	"S+poarps+NEW: n=%i, r=%i, s=%i"
	.align	3
.LC27:
	.string	", st=%i"
	.align	3
...
.LC36:
	...
	.align	3
.LC37:
	.string	"S+poarps+NEW, sum_hist"
	.align	3
.LC38:
	.string	"Test S+poarps+NEW Allowed\n"
	.align	3
.LC39:
	.string	"Histogram (%d states)\n"
	.align	3
.LC40:
	.string	"Observation S+poarps+NEW %s %lu %lu\n"
	.align	3
.LC42:
	.string	"Time S+poarps+NEW %.2f\n"
	.align	3
.LC43:
	.string	"Ok"
	.align	3
...
.LC46:
	...
	.align	3
.LC47:
	.string	"Hash=312f7d5857047c1f5e01a5598066ae6b\n"
	.align	3
.LC48:
	.string	"Cycle=RfePAR PodRWARP WsePAR PodWWARP\n"
	.align	3
.LC49:
	.string	"AR"
	.align	3
.LC50:
	.string	"Relax S+poarps+NEW %s %s\n"
	.align	3
.LC51:
...
.LC53:
	...
	.align	3
.LC54:
	.string	"Orig=PodWWARP RfePAR PodRWARP WsePAR\n"
	.align	3
.LC55:
	.string	"No"
	.align	3
...
.LC57:
	...
	.text
	.align	1
	.globl	S_2B_poarps_2B_NEW
	.type	S_2B_poarps_2B_NEW, @function
S_2B_poarps_2B_NEW:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_poarps_2B_NEW, .-S_2B_poarps_2B_NEW
	.section	.rodata.str1.8
	.align	3
.LC58:
	.string	"[[0],[1]]"
