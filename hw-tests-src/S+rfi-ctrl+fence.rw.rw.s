...
.L2:
	...
	.align	3
.LC1:
	.string	"S+rfi-ctrl+fence.rw.rw, check_globals failed"
	.text
	.align	1
...
.L49:
	...
	add	a4,a4,a3
#APP
# 277 "S+rfi-ctrl+fence.rw.rw.c" 1
...
.L67:
	...
	add	a4,a4,a3
#APP
# 238 "S+rfi-ctrl+fence.rw.rw.c" 1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+rfi-ctrl+fence.rw.rw, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/Rfi/S+rfi-ctrl+fence.rw.rw.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+rfi-ctrl+fence.rw.rw"
	.align	3
.LC13:
	.string	"\"Rfi DpCtrldW Rfe Fence.rw.rwdRW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC28:
	...
	.align	3
.LC29:
	.string	"S+rfi-ctrl+fence.rw.rw: n=%i, r=%i, s=%i"
	.align	3
.LC30:
	.string	", st=%i"
	.align	3
...
.LC39:
	...
	.align	3
.LC40:
	.string	"S+rfi-ctrl+fence.rw.rw, sum_hist"
	.align	3
.LC41:
	.string	"Test S+rfi-ctrl+fence.rw.rw Allowed\n"
	.align	3
.LC42:
	.string	"Histogram (%d states)\n"
	.align	3
.LC43:
	.string	"Observation S+rfi-ctrl+fence.rw.rw %s %lu %lu\n"
	.align	3
.LC45:
	.string	"Time S+rfi-ctrl+fence.rw.rw %.2f\n"
	.align	3
.LC46:
	.string	"Ok"
	.align	3
...
.LC49:
	...
	.align	3
.LC50:
	.string	"Hash=e859c5d3eb7cb6fca81fe186c762e61a\n"
	.align	3
.LC51:
	.string	"Cycle=Rfi DpCtrldW Rfe Fence.rw.rwdRW Wse\n"
	.align	3
.LC52:
	.string	"Rfi"
	.align	3
.LC53:
	.string	"Relax S+rfi-ctrl+fence.rw.rw %s %s\n"
	.align	3
.LC54:
	.string	"Safe=Rfe Wse Fence.rw.rwdRW DpCtrldW\n"
	.align	3
.LC55:
...
.LC56:
	...
	.align	3
.LC57:
	.string	"Orig=Rfi DpCtrldW Rfe Fence.rw.rwdRW Wse\n"
	.align	3
.LC58:
	.string	"No"
	.align	3
...
.LC60:
	...
	.text
	.align	1
	.globl	S_2B_rfi_2D_ctrl_2B_fence_2E_rw_2E_rw
	.type	S_2B_rfi_2D_ctrl_2B_fence_2E_rw_2E_rw, @function
S_2B_rfi_2D_ctrl_2B_fence_2E_rw_2E_rw:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L235:
	call	__stack_chk_fail@plt
	.size	S_2B_rfi_2D_ctrl_2B_fence_2E_rw_2E_rw, .-S_2B_rfi_2D_ctrl_2B_fence_2E_rw_2E_rw
	.section	.rodata.str1.8
	.align	3
.LC61:
	.string	"[[0],[1]]"
