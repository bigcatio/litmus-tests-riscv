...
.L2:
	...
	.align	3
.LC1:
	.string	"S+fence.tsos, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+fence.tsos, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/FENCE.TSO/2/S+fence.tsos.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+fence.tsos"
	.align	3
.LC13:
	.string	"\"Fence.tsodWW Rfe Fence.tsodRW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC26:
	...
	.align	3
.LC27:
	.string	"S+fence.tsos: n=%i, r=%i, s=%i"
	.align	3
.LC28:
	.string	", st=%i"
	.align	3
...
.LC37:
	...
	.align	3
.LC38:
	.string	"S+fence.tsos, sum_hist"
	.align	3
.LC39:
	.string	"Test S+fence.tsos Allowed\n"
	.align	3
.LC40:
	.string	"Histogram (%d states)\n"
	.align	3
.LC41:
	.string	"Observation S+fence.tsos %s %lu %lu\n"
	.align	3
.LC43:
	.string	"Time S+fence.tsos %.2f\n"
	.align	3
.LC44:
	.string	"Ok"
	.align	3
...
.LC47:
	...
	.align	3
.LC48:
	.string	"Hash=63875a6cb799e5cfd02bce5b865df738\n"
	.align	3
.LC49:
	.string	"Cycle=Rfe Fence.tsodRW Wse Fence.tsodWW\n"
	.align	3
.LC50:
	.string	"Relax S+fence.tsos %s %s\n"
	.align	3
.LC51:
	.string	"Safe=Rfe Wse Fence.tsodWW Fence.tsodRW\n"
	.align	3
.LC52:
...
.LC53:
	...
	.align	3
.LC54:
	.string	"Orig=Fence.tsodWW Rfe Fence.tsodRW Wse\n"
	.align	3
.LC55:
	.string	"No"
	.align	3
...
.LC57:
	...
	.text
	.align	1
	.globl	S_2B_fence_2E_tsos
	.type	S_2B_fence_2E_tsos, @function
S_2B_fence_2E_tsos:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_fence_2E_tsos, .-S_2B_fence_2E_tsos
	.section	.rodata.str1.8
	.align	3
.LC58:
	.string	"[[0],[1]]"
