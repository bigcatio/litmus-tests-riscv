...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+fence.tsos, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/FENCE.TSO/2/MP+fence.tsos.litmus %"
	.align	3
.LC10:
	.string	"RISCV MP+fence.tsos"
	.align	3
.LC11:
	.string	"\"Fence.tsodWW Rfe Fence.tsodRR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC24:
	...
	.align	3
.LC25:
	.string	"MP+fence.tsos: n=%i, r=%i, s=%i"
	.align	3
.LC26:
	.string	", st=%i"
	.align	3
...
.LC35:
	...
	.align	3
.LC36:
	.string	"MP+fence.tsos, sum_hist"
	.align	3
.LC37:
	.string	"Test MP+fence.tsos Allowed\n"
	.align	3
.LC38:
	.string	"Histogram (%d states)\n"
	.align	3
.LC39:
	.string	"Observation MP+fence.tsos %s %lu %lu\n"
	.align	3
.LC41:
	.string	"Time MP+fence.tsos %.2f\n"
	.align	3
.LC42:
	.string	"Ok"
	.align	3
...
.LC45:
	...
	.align	3
.LC46:
	.string	"Hash=8bc574b0163ad70d0ef60875b6604786\n"
	.align	3
.LC47:
	.string	"Cycle=Rfe Fence.tsodRR Fre Fence.tsodWW\n"
	.align	3
.LC48:
	.string	"Relax MP+fence.tsos %s %s\n"
	.align	3
.LC49:
	.string	"Safe=Rfe Fre Fence.tsodWW Fence.tsodRR\n"
	.align	3
.LC50:
...
.LC51:
	...
	.align	3
.LC52:
	.string	"Orig=Fence.tsodWW Rfe Fence.tsodRR Fre\n"
	.align	3
.LC53:
	.string	"No"
	.align	3
...
.LC55:
	...
	.text
	.align	1
	.globl	MP_2B_fence_2E_tsos
	.type	MP_2B_fence_2E_tsos, @function
MP_2B_fence_2E_tsos:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	MP_2B_fence_2E_tsos, .-MP_2B_fence_2E_tsos
	.section	.rodata.str1.8
	.align	3
.LC56:
	.string	"[[0],[1]]"
