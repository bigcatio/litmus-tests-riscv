...
.L2:
	...
	.align	3
.LC1:
	.string	"2+2W+poprls+NEW, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"2+2W+poprls+NEW, global x unstabilized"
	.align	3
.LC6:
	.string	"2+2W+poprls+NEW, global y unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC11:
	...
	.align	3
.LC12:
	.string	"% Results for tests/non-mixed-size/AMO_X0_2_THREAD/2+2W+poprls+NEW.litmus %"
	.align	3
.LC13:
	.string	"RISCV 2+2W+poprls+NEW"
	.align	3
.LC14:
	.string	"\"PodWWPRl WseRlP PodWWPRl WseRlP\""
	.align	3
.LC15:
	.string	"{"
	.align	3
...
.LC26:
	...
	.align	3
.LC27:
	.string	"2+2W+poprls+NEW: n=%i, r=%i, s=%i"
	.align	3
.LC28:
	.string	", st=%i"
	.align	3
...
.LC37:
	...
	.align	3
.LC38:
	.string	"2+2W+poprls+NEW, sum_hist"
	.align	3
.LC39:
	.string	"Test 2+2W+poprls+NEW Allowed\n"
	.align	3
.LC40:
	.string	"Histogram (%d states)\n"
	.align	3
.LC41:
	.string	"Observation 2+2W+poprls+NEW %s %lu %lu\n"
	.align	3
.LC43:
	.string	"Time 2+2W+poprls+NEW %.2f\n"
	.align	3
.LC44:
	.string	"Ok"
	.align	3
...
.LC47:
	...
	.align	3
.LC48:
	.string	"Hash=d637d1942e497b6e84e24bae60f82987\n"
	.align	3
.LC49:
	.string	"Cycle=PodWWPRl WseRlP PodWWPRl WseRlP\n"
	.align	3
.LC50:
	.string	"Rl"
	.align	3
.LC51:
	.string	"Relax 2+2W+poprls+NEW %s %s\n"
	.align	3
.LC52:
...
.LC54:
	...
	.align	3
.LC55:
	.string	"Orig=PodWWPRl WseRlP PodWWPRl WseRlP\n"
	.align	3
.LC56:
	.string	"No"
	.align	3
...
.LC58:
	...
	.text
	.align	1
	.globl	_X2_2B_2W_2B_poprls_2B_NEW
	.type	_X2_2B_2W_2B_poprls_2B_NEW, @function
_X2_2B_2W_2B_poprls_2B_NEW:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L236:
	call	__stack_chk_fail@plt
	.size	_X2_2B_2W_2B_poprls_2B_NEW, .-_X2_2B_2W_2B_poprls_2B_NEW
	.section	.rodata.str1.8
	.align	3
.LC59:
	.string	"[[0],[1]]"
