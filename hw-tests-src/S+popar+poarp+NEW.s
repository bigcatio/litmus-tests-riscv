...
.L2:
	...
	.align	3
.LC1:
	.string	"S+popar+poarp+NEW, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+popar+poarp+NEW, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/AMO_X0_2_THREAD/S+popar+poarp+NEW.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+popar+poarp+NEW"
	.align	3
.LC13:
	.string	"\"PodWWPAR RfeARAR PodRWARP Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC25:
	...
	.align	3
.LC26:
	.string	"S+popar+poarp+NEW: n=%i, r=%i, s=%i"
	.align	3
.LC27:
	.string	", st=%i"
	.align	3
...
.LC36:
	...
	.align	3
.LC37:
	.string	"S+popar+poarp+NEW, sum_hist"
	.align	3
.LC38:
	.string	"Test S+popar+poarp+NEW Allowed\n"
	.align	3
.LC39:
	.string	"Histogram (%d states)\n"
	.align	3
.LC40:
	.string	"Observation S+popar+poarp+NEW %s %lu %lu\n"
	.align	3
.LC42:
	.string	"Time S+popar+poarp+NEW %.2f\n"
	.align	3
.LC43:
	.string	"Ok"
	.align	3
...
.LC46:
	...
	.align	3
.LC47:
	.string	"Hash=5d81e8cbbe0a6eaccdfdf6f7d65abe78\n"
	.align	3
.LC48:
	.string	"Cycle=Wse PodWWPAR RfeARAR PodRWARP\n"
	.align	3
.LC49:
	.string	"AR"
	.align	3
.LC50:
	.string	"Relax S+popar+poarp+NEW %s %s\n"
	.align	3
.LC51:
...
.LC53:
	...
	.align	3
.LC54:
	.string	"Orig=PodWWPAR RfeARAR PodRWARP Wse\n"
	.align	3
.LC55:
	.string	"No"
	.align	3
...
.LC57:
	...
	.text
	.align	1
	.globl	S_2B_popar_2B_poarp_2B_NEW
	.type	S_2B_popar_2B_poarp_2B_NEW, @function
S_2B_popar_2B_poarp_2B_NEW:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_popar_2B_poarp_2B_NEW, .-S_2B_popar_2B_poarp_2B_NEW
	.section	.rodata.str1.8
	.align	3
.LC58:
	.string	"[[0],[1]]"
