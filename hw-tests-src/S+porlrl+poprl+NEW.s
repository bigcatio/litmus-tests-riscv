...
.L2:
	...
	.align	3
.LC1:
	.string	"S+porlrl+poprl+NEW, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+porlrl+poprl+NEW, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/AMO_X0_2_THREAD/S+porlrl+poprl+NEW.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+porlrl+poprl+NEW"
	.align	3
.LC13:
	.string	"\"PodWWRlRl RfeRlP PodRWPRl WseRlRl\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC18:
	...
	.align	3
.LC19:
	.string	" amoswap.w.rl x0,x5,(x6) | lw x5,0(x6)             ;"
	.align	3
.LC20:
...
.LC25:
	...
	.align	3
.LC26:
	.string	"S+porlrl+poprl+NEW: n=%i, r=%i, s=%i"
	.align	3
.LC27:
	.string	", st=%i"
	.align	3
...
.LC36:
	...
	.align	3
.LC37:
	.string	"S+porlrl+poprl+NEW, sum_hist"
	.align	3
.LC38:
	.string	"Test S+porlrl+poprl+NEW Allowed\n"
	.align	3
.LC39:
	.string	"Histogram (%d states)\n"
	.align	3
.LC40:
	.string	"Observation S+porlrl+poprl+NEW %s %lu %lu\n"
	.align	3
.LC42:
	.string	"Time S+porlrl+poprl+NEW %.2f\n"
	.align	3
.LC43:
	.string	"Ok"
	.align	3
...
.LC46:
	...
	.align	3
.LC47:
	.string	"Hash=1ab8b35c57fcd35520686559472ba963\n"
	.align	3
.LC48:
	.string	"Cycle=PodRWPRl WseRlRl PodWWRlRl RfeRlP\n"
	.align	3
.LC49:
	.string	"Rl"
	.align	3
.LC50:
	.string	"Relax S+porlrl+poprl+NEW %s %s\n"
	.align	3
.LC51:
...
.LC53:
	...
	.align	3
.LC54:
	.string	"Orig=PodWWRlRl RfeRlP PodRWPRl WseRlRl\n"
	.align	3
.LC55:
	.string	"No"
	.align	3
...
.LC57:
	...
	.text
	.align	1
	.globl	S_2B_porlrl_2B_poprl_2B_NEW
	.type	S_2B_porlrl_2B_poprl_2B_NEW, @function
S_2B_porlrl_2B_poprl_2B_NEW:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_porlrl_2B_poprl_2B_NEW, .-S_2B_porlrl_2B_poprl_2B_NEW
	.section	.rodata.str1.8
	.align	3
.LC58:
	.string	"[[0],[1]]"
