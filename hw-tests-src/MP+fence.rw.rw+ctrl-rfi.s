	.file	"MP+fence.rw.rw+ctrl-rfi.c"
	.option pic
	.text
...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+fence.rw.rw+ctrl-rfi, check_globals failed"
	.text
	.align	1
...
.L28:
	...
	.align	3
.LC3:
	.string	"MP+fence.rw.rw+ctrl-rfi"
	.text
	.align	1
	.type	P1, @function
P1:
	...
	mv	s1,a0
#APP
# 47 "MP+fence.rw.rw+ctrl-rfi.c" 1
	fence rw,rw
# 0 "" 2
#NO_APP
	ld	s0,16(a0)
...
.L49:
	...
	add	a4,a4,a3
#APP
# 273 "MP+fence.rw.rw+ctrl-rfi.c" 1
...
.L67:
	...
	add	a4,a4,a3
#APP
# 238 "MP+fence.rw.rw+ctrl-rfi.c" 1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"MP+fence.rw.rw+ctrl-rfi, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/Rfi/MP+fence.rw.rw+ctrl-rfi.litmus %"
	.align	3
.LC12:
	.string	"RISCV MP+fence.rw.rw+ctrl-rfi"
	.align	3
.LC13:
	.string	"\"Fence.rw.rwdWW Rfe DpCtrldW Rfi Fre\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC28:
	...
	.align	3
.LC29:
	.string	"MP+fence.rw.rw+ctrl-rfi: n=%i, r=%i, s=%i"
	.align	3
.LC30:
	.string	", st=%i"
	.align	3
...
.LC39:
	...
	.align	3
.LC40:
	.string	"MP+fence.rw.rw+ctrl-rfi, sum_hist"
	.align	3
.LC41:
	.string	"Test MP+fence.rw.rw+ctrl-rfi Allowed\n"
	.align	3
.LC42:
	.string	"Histogram (%d states)\n"
	.align	3
.LC43:
	.string	"Observation MP+fence.rw.rw+ctrl-rfi %s %lu %lu\n"
	.align	3
.LC45:
	.string	"Time MP+fence.rw.rw+ctrl-rfi %.2f\n"
	.align	3
.LC46:
	.string	"Ok"
	.align	3
...
.LC49:
	...
	.align	3
.LC50:
	.string	"Hash=16938edb4a4beda7d4a200e156fa388b\n"
	.align	3
.LC51:
	.string	"Cycle=Rfi Fre Fence.rw.rwdWW Rfe DpCtrldW\n"
	.align	3
.LC52:
	.string	"Rfi"
	.align	3
.LC53:
	.string	"Relax MP+fence.rw.rw+ctrl-rfi %s %s\n"
	.align	3
.LC54:
	.string	"Safe=Rfe Fre Fence.rw.rwdWW DpCtrldW\n"
	.align	3
.LC55:
...
.LC56:
	...
	.align	3
.LC57:
	.string	"Orig=Fence.rw.rwdWW Rfe DpCtrldW Rfi Fre\n"
	.align	3
.LC58:
	.string	"No"
	.align	3
...
.LC60:
	...
	.text
	.align	1
	.globl	MP_2B_fence_2E_rw_2E_rw_2B_ctrl_2D_rfi
	.type	MP_2B_fence_2E_rw_2E_rw_2B_ctrl_2D_rfi, @function
MP_2B_fence_2E_rw_2E_rw_2B_ctrl_2D_rfi:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L235:
	call	__stack_chk_fail@plt
	.size	MP_2B_fence_2E_rw_2E_rw_2B_ctrl_2D_rfi, .-MP_2B_fence_2E_rw_2E_rw_2B_ctrl_2D_rfi
	.section	.rodata.str1.8
	.align	3
.LC61:
	.string	"[[0],[1]]"
