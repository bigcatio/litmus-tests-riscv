...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+poarps+NEW, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/AMO_X0_2_THREAD/MP+poarps+NEW.litmus %"
	.align	3
.LC10:
	.string	"RISCV MP+poarps+NEW"
	.align	3
.LC11:
	.string	"\"PodWWARP RfePAR PodRRARP FrePAR\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC23:
	...
	.align	3
.LC24:
	.string	"MP+poarps+NEW: n=%i, r=%i, s=%i"
	.align	3
.LC25:
	.string	", st=%i"
	.align	3
...
.LC34:
	...
	.align	3
.LC35:
	.string	"MP+poarps+NEW, sum_hist"
	.align	3
.LC36:
	.string	"Test MP+poarps+NEW Allowed\n"
	.align	3
.LC37:
	.string	"Histogram (%d states)\n"
	.align	3
.LC38:
	.string	"Observation MP+poarps+NEW %s %lu %lu\n"
	.align	3
.LC40:
	.string	"Time MP+poarps+NEW %.2f\n"
	.align	3
.LC41:
	.string	"Ok"
	.align	3
...
.LC44:
	...
	.align	3
.LC45:
	.string	"Hash=0d140bda2f37c52330ba732d1d245d88\n"
	.align	3
.LC46:
	.string	"Cycle=RfePAR PodRRARP FrePAR PodWWARP\n"
	.align	3
.LC47:
	.string	"AR"
	.align	3
.LC48:
	.string	"Relax MP+poarps+NEW %s %s\n"
	.align	3
.LC49:
...
.LC51:
	...
	.align	3
.LC52:
	.string	"Orig=PodWWARP RfePAR PodRRARP FrePAR\n"
	.align	3
.LC53:
	.string	"No"
	.align	3
...
.LC55:
	...
	.text
	.align	1
	.globl	MP_2B_poarps_2B_NEW
	.type	MP_2B_poarps_2B_NEW, @function
MP_2B_poarps_2B_NEW:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	MP_2B_poarps_2B_NEW, .-MP_2B_poarps_2B_NEW
	.section	.rodata.str1.8
	.align	3
.LC56:
	.string	"[[0],[1]]"
