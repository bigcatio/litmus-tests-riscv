...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+rfi-ctrl+data-rfi, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"MP+rfi-ctrl+data-rfi, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/Rfi/MP+rfi-ctrl+data-rfi.litmus %"
	.align	3
.LC12:
	.string	"RISCV MP+rfi-ctrl+data-rfi"
	.align	3
.LC13:
	.string	"\"Rfi DpCtrldW Rfe DpDatadW Rfi Fre\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC28:
	...
	.align	3
.LC29:
	.string	"MP+rfi-ctrl+data-rfi: n=%i, r=%i, s=%i"
	.align	3
.LC30:
	.string	", st=%i"
	.align	3
...
.LC39:
	...
	.align	3
.LC40:
	.string	"MP+rfi-ctrl+data-rfi, sum_hist"
	.align	3
.LC41:
	.string	"Test MP+rfi-ctrl+data-rfi Allowed\n"
	.align	3
.LC42:
	.string	"Histogram (%d states)\n"
	.align	3
.LC43:
	.string	"Observation MP+rfi-ctrl+data-rfi %s %lu %lu\n"
	.align	3
.LC45:
	.string	"Time MP+rfi-ctrl+data-rfi %.2f\n"
	.align	3
.LC46:
	.string	"Ok"
	.align	3
...
.LC49:
	...
	.align	3
.LC50:
	.string	"Hash=1edd150eb5fc154579949cf9d4b58349\n"
	.align	3
.LC51:
	.string	"Cycle=Rfi Fre Rfi DpCtrldW Rfe DpDatadW\n"
	.align	3
.LC52:
	.string	"Rfi"
	.align	3
.LC53:
	.string	"Relax MP+rfi-ctrl+data-rfi %s %s\n"
	.align	3
.LC54:
...
.LC56:
	...
	.align	3
.LC57:
	.string	"Orig=Rfi DpCtrldW Rfe DpDatadW Rfi Fre\n"
	.align	3
.LC58:
	.string	"No"
	.align	3
...
.LC60:
	...
	.text
	.align	1
	.globl	MP_2B_rfi_2D_ctrl_2B_data_2D_rfi
	.type	MP_2B_rfi_2D_ctrl_2B_data_2D_rfi, @function
MP_2B_rfi_2D_ctrl_2B_data_2D_rfi:
	addi	sp,sp,-528
	sd	s0,512(sp)
	sd	s1,504(sp)
	sd	s2,496(sp)
...
.L238:
	call	__stack_chk_fail@plt
	.size	MP_2B_rfi_2D_ctrl_2B_data_2D_rfi, .-MP_2B_rfi_2D_ctrl_2B_data_2D_rfi
	.section	.rodata.str1.8
	.align	3
.LC61:
	.string	"[[0],[1]]"
