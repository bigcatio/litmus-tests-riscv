...
.L2:
	...
	.align	3
.LC1:
	.string	"LB+data+data-rfi-addr, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/Rfi/LB+data+data-rfi-addr.litmus %"
	.align	3
.LC10:
	.string	"RISCV LB+data+data-rfi-addr"
	.align	3
.LC11:
	.string	"\"DpDatadW Rfe DpDatadW Rfi DpAddrdW Rfe\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC29:
	...
	.align	3
.LC30:
	.string	"LB+data+data-rfi-addr: n=%i, r=%i, s=%i"
	.align	3
.LC31:
	.string	", st=%i"
	.align	3
...
.LC40:
	...
	.align	3
.LC41:
	.string	"LB+data+data-rfi-addr, sum_hist"
	.align	3
.LC42:
	.string	"Test LB+data+data-rfi-addr Allowed\n"
	.align	3
.LC43:
	.string	"Histogram (%d states)\n"
	.align	3
.LC44:
	.string	"Observation LB+data+data-rfi-addr %s %lu %lu\n"
	.align	3
.LC46:
	.string	"Time LB+data+data-rfi-addr %.2f\n"
	.align	3
.LC47:
	.string	"Ok"
	.align	3
...
.LC50:
	...
	.align	3
.LC51:
	.string	"Hash=6fee53156615163b36fbdab5ead69d38\n"
	.align	3
.LC52:
	.string	"Cycle=Rfi DpAddrdW Rfe DpDatadW Rfe DpDatadW\n"
	.align	3
.LC53:
	.string	"Rfi"
	.align	3
.LC54:
	.string	"Relax LB+data+data-rfi-addr %s %s\n"
	.align	3
.LC55:
...
.LC57:
	...
	.align	3
.LC58:
	.string	"Orig=DpDatadW Rfe DpDatadW Rfi DpAddrdW Rfe\n"
	.align	3
.LC59:
	.string	"No"
	.align	3
...
.LC61:
	...
	.text
	.align	1
	.globl	LB_2B_data_2B_data_2D_rfi_2D_addr
	.type	LB_2B_data_2B_data_2D_rfi_2D_addr, @function
LB_2B_data_2B_data_2D_rfi_2D_addr:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L225:
	call	__stack_chk_fail@plt
	.size	LB_2B_data_2B_data_2D_rfi_2D_addr, .-LB_2B_data_2B_data_2D_rfi_2D_addr
	.section	.rodata.str1.8
	.align	3
.LC62:
	.string	"[[0],[1]]"
