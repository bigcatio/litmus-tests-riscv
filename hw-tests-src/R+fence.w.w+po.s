...
.L2:
	...
	.align	3
.LC1:
	.string	"R+fence.w.w+po, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"R+fence.w.w+po, global y unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/PodWR/R+fence.w.w+po.litmus %"
	.align	3
.LC12:
	.string	"RISCV R+fence.w.w+po"
	.align	3
.LC13:
	.string	"\"Fence.w.wdWW Wse PodWR Fre\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC26:
	...
	.align	3
.LC27:
	.string	"R+fence.w.w+po: n=%i, r=%i, s=%i"
	.align	3
.LC28:
	.string	", st=%i"
	.align	3
...
.LC37:
	...
	.align	3
.LC38:
	.string	"R+fence.w.w+po, sum_hist"
	.align	3
.LC39:
	.string	"Test R+fence.w.w+po Allowed\n"
	.align	3
.LC40:
	.string	"Histogram (%d states)\n"
	.align	3
.LC41:
	.string	"Observation R+fence.w.w+po %s %lu %lu\n"
	.align	3
.LC43:
	.string	"Time R+fence.w.w+po %.2f\n"
	.align	3
.LC44:
	.string	"Ok"
	.align	3
...
.LC47:
	...
	.align	3
.LC48:
	.string	"Hash=80ccac35d0e7b7ada43200574611530d\n"
	.align	3
.LC49:
	.string	"Cycle=Fre Fence.w.wdWW Wse PodWR\n"
	.align	3
.LC50:
	.string	"PodWR"
	.align	3
.LC51:
	.string	"Relax R+fence.w.w+po %s %s\n"
	.align	3
.LC52:
...
.LC54:
	...
	.align	3
.LC55:
	.string	"Orig=Fence.w.wdWW Wse PodWR Fre\n"
	.align	3
.LC56:
	.string	"No"
	.align	3
...
.LC58:
	...
	.text
	.align	1
	.globl	R_2B_fence_2E_w_2E_w_2B_po
	.type	R_2B_fence_2E_w_2E_w_2B_po, @function
R_2B_fence_2E_w_2E_w_2B_po:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	R_2B_fence_2E_w_2E_w_2B_po, .-R_2B_fence_2E_w_2E_w_2B_po
	.section	.rodata.str1.8
	.align	3
.LC59:
	.string	"[[0],[1]]"
