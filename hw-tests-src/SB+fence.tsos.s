...
.L2:
	...
	.align	3
.LC1:
	.string	"SB+fence.tsos, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/FENCE.TSO/2/SB+fence.tsos.litmus %"
	.align	3
.LC10:
	.string	"RISCV SB+fence.tsos"
	.align	3
.LC11:
	.string	"\"Fence.tsodWR Fre Fence.tsodWR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC24:
	...
	.align	3
.LC25:
	.string	"SB+fence.tsos: n=%i, r=%i, s=%i"
	.align	3
.LC26:
	.string	", st=%i"
	.align	3
...
.LC35:
	...
	.align	3
.LC36:
	.string	"SB+fence.tsos, sum_hist"
	.align	3
.LC37:
	.string	"Test SB+fence.tsos Allowed\n"
	.align	3
.LC38:
	.string	"Histogram (%d states)\n"
	.align	3
.LC39:
	.string	"Observation SB+fence.tsos %s %lu %lu\n"
	.align	3
.LC41:
	.string	"Time SB+fence.tsos %.2f\n"
	.align	3
.LC42:
	.string	"Ok"
	.align	3
...
.LC45:
	...
	.align	3
.LC46:
	.string	"Hash=4d63bf35caec0ab5c3a94ea62666147d\n"
	.align	3
.LC47:
	.string	"Cycle=Fre Fence.tsodWR Fre Fence.tsodWR\n"
	.align	3
.LC48:
	.string	"Relax SB+fence.tsos %s %s\n"
	.align	3
.LC49:
	.string	"Safe=Fre Fence.tsodWR\n"
	.align	3
.LC50:
...
.LC51:
	...
	.align	3
.LC52:
	.string	"Orig=Fence.tsodWR Fre Fence.tsodWR Fre\n"
	.align	3
.LC53:
	.string	"No"
	.align	3
...
.LC55:
	...
	.text
	.align	1
	.globl	SB_2B_fence_2E_tsos
	.type	SB_2B_fence_2E_tsos, @function
SB_2B_fence_2E_tsos:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	SB_2B_fence_2E_tsos, .-SB_2B_fence_2E_tsos
	.section	.rodata.str1.8
	.align	3
.LC56:
	.string	"[[0],[1]]"
