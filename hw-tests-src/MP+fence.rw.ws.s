...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+fence.rw.ws, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/Fence.rw.wdRR/MP+fence.rw.ws.litmus %"
	.align	3
.LC10:
	.string	"RISCV MP+fence.rw.ws"
	.align	3
.LC11:
	.string	"\"Fence.rw.wdWW Rfe Fence.rw.wdRR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC24:
	...
	.align	3
.LC25:
	.string	"MP+fence.rw.ws: n=%i, r=%i, s=%i"
	.align	3
.LC26:
	.string	", st=%i"
	.align	3
...
.LC35:
	...
	.align	3
.LC36:
	.string	"MP+fence.rw.ws, sum_hist"
	.align	3
.LC37:
	.string	"Test MP+fence.rw.ws Allowed\n"
	.align	3
.LC38:
	.string	"Histogram (%d states)\n"
	.align	3
.LC39:
	.string	"Observation MP+fence.rw.ws %s %lu %lu\n"
	.align	3
.LC41:
	.string	"Time MP+fence.rw.ws %.2f\n"
	.align	3
.LC42:
	.string	"Ok"
	.align	3
...
.LC45:
	...
	.align	3
.LC46:
	.string	"Hash=1969416413b3dc01cc320793585eb336\n"
	.align	3
.LC47:
	.string	"Cycle=Rfe Fence.rw.wdRR Fre Fence.rw.wdWW\n"
	.align	3
.LC48:
	.string	"Fence.rw.wdRR"
	.align	3
.LC49:
	.string	"Relax MP+fence.rw.ws %s %s\n"
	.align	3
.LC50:
...
.LC52:
	...
	.align	3
.LC53:
	.string	"Orig=Fence.rw.wdWW Rfe Fence.rw.wdRR Fre\n"
	.align	3
.LC54:
	.string	"No"
	.align	3
...
.LC56:
	...
	.text
	.align	1
	.globl	MP_2B_fence_2E_rw_2E_ws
	.type	MP_2B_fence_2E_rw_2E_ws, @function
MP_2B_fence_2E_rw_2E_ws:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	MP_2B_fence_2E_rw_2E_ws, .-MP_2B_fence_2E_rw_2E_ws
	.section	.rodata.str1.8
	.align	3
.LC57:
	.string	"[[0],[1]]"
