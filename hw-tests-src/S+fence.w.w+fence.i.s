...
.L2:
	...
	.align	3
.LC1:
	.string	"S+fence.w.w+fence.i, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+fence.w.w+fence.i, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/Fence.idRW/S+fence.w.w+fence.i.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+fence.w.w+fence.i"
	.align	3
.LC13:
	.string	"\"Fence.w.wdWW Rfe Fence.idRW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC26:
	...
	.align	3
.LC27:
	.string	"S+fence.w.w+fence.i: n=%i, r=%i, s=%i"
	.align	3
.LC28:
	.string	", st=%i"
	.align	3
...
.LC37:
	...
	.align	3
.LC38:
	.string	"S+fence.w.w+fence.i, sum_hist"
	.align	3
.LC39:
	.string	"Test S+fence.w.w+fence.i Allowed\n"
	.align	3
.LC40:
	.string	"Histogram (%d states)\n"
	.align	3
.LC41:
	.string	"Observation S+fence.w.w+fence.i %s %lu %lu\n"
	.align	3
.LC43:
	.string	"Time S+fence.w.w+fence.i %.2f\n"
	.align	3
.LC44:
	.string	"Ok"
	.align	3
...
.LC47:
	...
	.align	3
.LC48:
	.string	"Hash=e690e0ae158daaf08c7e93ef32f1d12a\n"
	.align	3
.LC49:
	.string	"Cycle=Rfe Fence.idRW Wse Fence.w.wdWW\n"
	.align	3
.LC50:
	.string	"Fence.idRW"
	.align	3
.LC51:
	.string	"Relax S+fence.w.w+fence.i %s %s\n"
	.align	3
.LC52:
	.string	"Safe=Rfe Wse Fence.w.wdWW\n"
	.align	3
.LC53:
...
.LC54:
	...
	.align	3
.LC55:
	.string	"Orig=Fence.w.wdWW Rfe Fence.idRW Wse\n"
	.align	3
.LC56:
	.string	"No"
	.align	3
...
.LC58:
	...
	.text
	.align	1
	.globl	S_2B_fence_2E_w_2E_w_2B_fence_2E_i
	.type	S_2B_fence_2E_w_2E_w_2B_fence_2E_i, @function
S_2B_fence_2E_w_2E_w_2B_fence_2E_i:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_fence_2E_w_2E_w_2B_fence_2E_i, .-S_2B_fence_2E_w_2E_w_2B_fence_2E_i
	.section	.rodata.str1.8
	.align	3
.LC59:
	.string	"[[0],[1]]"
