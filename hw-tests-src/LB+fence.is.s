...
.L2:
	...
	.align	3
.LC1:
	.string	"LB+fence.is, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/Fence.idRW/LB+fence.is.litmus %"
	.align	3
.LC10:
	.string	"RISCV LB+fence.is"
	.align	3
.LC11:
	.string	"\"Fence.idRW Rfe Fence.idRW Rfe\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC24:
	...
	.align	3
.LC25:
	.string	"LB+fence.is: n=%i, r=%i, s=%i"
	.align	3
.LC26:
	.string	", st=%i"
	.align	3
...
.LC35:
	...
	.align	3
.LC36:
	.string	"LB+fence.is, sum_hist"
	.align	3
.LC37:
	.string	"Test LB+fence.is Allowed\n"
	.align	3
.LC38:
	.string	"Histogram (%d states)\n"
	.align	3
.LC39:
	.string	"Observation LB+fence.is %s %lu %lu\n"
	.align	3
.LC41:
	.string	"Time LB+fence.is %.2f\n"
	.align	3
.LC42:
	.string	"Ok"
	.align	3
...
.LC45:
	...
	.align	3
.LC46:
	.string	"Hash=fb7761ac9d4b091089d71da5ce51c44a\n"
	.align	3
.LC47:
	.string	"Cycle=Rfe Fence.idRW Rfe Fence.idRW\n"
	.align	3
.LC48:
	.string	"Fence.idRW"
	.align	3
.LC49:
	.string	"Relax LB+fence.is %s %s\n"
	.align	3
.LC50:
	.string	"Safe=Rfe\n"
	.align	3
...
.LC52:
	...
	.align	3
.LC53:
	.string	"Orig=Fence.idRW Rfe Fence.idRW Rfe\n"
	.align	3
.LC54:
	.string	"No"
	.align	3
...
.LC56:
	...
	.text
	.align	1
	.globl	LB_2B_fence_2E_is
	.type	LB_2B_fence_2E_is, @function
LB_2B_fence_2E_is:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	LB_2B_fence_2E_is, .-LB_2B_fence_2E_is
	.section	.rodata.str1.8
	.align	3
.LC57:
	.string	"[[0],[1]]"
