...
.L2:
	...
	.align	3
.LC1:
	.string	"S+fence.r.rw+ctrl, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+fence.r.rw+ctrl, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/Fence.r.rwdWW/S+fence.r.rw+ctrl.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+fence.r.rw+ctrl"
	.align	3
.LC13:
	.string	"\"Fence.r.rwdWW Rfe DpCtrldW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC27:
	...
	.align	3
.LC28:
	.string	"S+fence.r.rw+ctrl: n=%i, r=%i, s=%i"
	.align	3
.LC29:
	.string	", st=%i"
	.align	3
...
.LC38:
	...
	.align	3
.LC39:
	.string	"S+fence.r.rw+ctrl, sum_hist"
	.align	3
.LC40:
	.string	"Test S+fence.r.rw+ctrl Allowed\n"
	.align	3
.LC41:
	.string	"Histogram (%d states)\n"
	.align	3
.LC42:
	.string	"Observation S+fence.r.rw+ctrl %s %lu %lu\n"
	.align	3
.LC44:
	.string	"Time S+fence.r.rw+ctrl %.2f\n"
	.align	3
.LC45:
	.string	"Ok"
	.align	3
...
.LC48:
	...
	.align	3
.LC49:
	.string	"Hash=1c7ec880edcd11e3189cb2f75e4f2dfb\n"
	.align	3
.LC50:
	.string	"Cycle=Rfe DpCtrldW Wse Fence.r.rwdWW\n"
	.align	3
.LC51:
	.string	"Fence.r.rwdWW"
	.align	3
.LC52:
	.string	"Relax S+fence.r.rw+ctrl %s %s\n"
	.align	3
.LC53:
...
.LC55:
	...
	.align	3
.LC56:
	.string	"Orig=Fence.r.rwdWW Rfe DpCtrldW Wse\n"
	.align	3
.LC57:
	.string	"No"
	.align	3
...
.LC59:
	...
	.text
	.align	1
	.globl	S_2B_fence_2E_r_2E_rw_2B_ctrl
	.type	S_2B_fence_2E_r_2E_rw_2B_ctrl, @function
S_2B_fence_2E_r_2E_rw_2B_ctrl:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_fence_2E_r_2E_rw_2B_ctrl, .-S_2B_fence_2E_r_2E_rw_2B_ctrl
	.section	.rodata.str1.8
	.align	3
.LC60:
	.string	"[[0],[1]]"
