...
.L2:
	...
	.align	3
.LC1:
	.string	"S+po+popar+NEW, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+po+popar+NEW, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/AMO_X0_2_THREAD/S+po+popar+NEW.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+po+popar+NEW"
	.align	3
.LC13:
	.string	"\"PodWW Rfe PodRWPAR WseARP\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC25:
	...
	.align	3
.LC26:
	.string	"S+po+popar+NEW: n=%i, r=%i, s=%i"
	.align	3
.LC27:
	.string	", st=%i"
	.align	3
...
.LC36:
	...
	.align	3
.LC37:
	.string	"S+po+popar+NEW, sum_hist"
	.align	3
.LC38:
	.string	"Test S+po+popar+NEW Allowed\n"
	.align	3
.LC39:
	.string	"Histogram (%d states)\n"
	.align	3
.LC40:
	.string	"Observation S+po+popar+NEW %s %lu %lu\n"
	.align	3
.LC42:
	.string	"Time S+po+popar+NEW %.2f\n"
	.align	3
.LC43:
	.string	"Ok"
	.align	3
...
.LC46:
	...
	.align	3
.LC47:
	.string	"Hash=11e2f158a0ab0df79c6c8e16470eb8a2\n"
	.align	3
.LC48:
	.string	"Cycle=Rfe PodRWPAR WseARP PodWW\n"
	.align	3
.LC49:
	.string	"AR"
	.align	3
.LC50:
	.string	"Relax S+po+popar+NEW %s %s\n"
	.align	3
.LC51:
...
.LC53:
	...
	.align	3
.LC54:
	.string	"Orig=PodWW Rfe PodRWPAR WseARP\n"
	.align	3
.LC55:
	.string	"No"
	.align	3
...
.LC57:
	...
	.text
	.align	1
	.globl	S_2B_po_2B_popar_2B_NEW
	.type	S_2B_po_2B_popar_2B_NEW, @function
S_2B_po_2B_popar_2B_NEW:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_po_2B_popar_2B_NEW, .-S_2B_po_2B_popar_2B_NEW
	.section	.rodata.str1.8
	.align	3
.LC58:
	.string	"[[0],[1]]"
