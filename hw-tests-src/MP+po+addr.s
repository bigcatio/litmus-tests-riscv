...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+po+addr, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/PodWW/MP+po+addr.litmus %"
	.align	3
.LC10:
	.string	"RISCV MP+po+addr"
	.align	3
.LC11:
	.string	"\"PodWW Rfe DpAddrdR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC17:
	...
	.align	3
.LC18:
	.string	" sw x5,0(x7) | xor x7,x5,x5  ;"
	.align	3
.LC19:
...
.LC36:
	...
	.align	3
.LC37:
	.string	"MP+po+addr, sum_hist"
	.align	3
.LC38:
	.string	"Test MP+po+addr Allowed\n"
	.align	3
.LC39:
	.string	"Histogram (%d states)\n"
	.align	3
.LC40:
	.string	"Observation MP+po+addr %s %lu %lu\n"
	.align	3
.LC42:
	.string	"Time MP+po+addr %.2f\n"
	.align	3
.LC43:
	.string	"Ok"
	.align	3
...
.LC46:
	...
	.align	3
.LC47:
	.string	"Hash=0b3d465f7d04ff928d794588a7b65343\n"
	.align	3
.LC48:
	.string	"Cycle=Rfe DpAddrdR Fre PodWW\n"
	.align	3
.LC49:
	.string	"PodWW"
	.align	3
.LC50:
	.string	"Relax MP+po+addr %s %s\n"
	.align	3
.LC51:
...
.LC53:
	...
	.align	3
.LC54:
	.string	"Orig=PodWW Rfe DpAddrdR Fre\n"
	.align	3
.LC55:
	.string	"No"
	.align	3
...
.LC57:
	...
	.text
	.align	1
	.globl	MP_2B_po_2B_addr
	.type	MP_2B_po_2B_addr, @function
MP_2B_po_2B_addr:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	MP_2B_po_2B_addr, .-MP_2B_po_2B_addr
	.section	.rodata.str1.8
	.align	3
.LC58:
	.string	"[[0],[1]]"
