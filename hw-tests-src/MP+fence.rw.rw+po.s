...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+fence.rw.rw+po, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/PodRR/MP+fence.rw.rw+po.litmus %"
	.align	3
.LC10:
	.string	"RISCV MP+fence.rw.rw+po"
	.align	3
.LC11:
	.string	"\"Fence.rw.rwdWW Rfe PodRR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC24:
	...
	.align	3
.LC25:
	.string	"MP+fence.rw.rw+po: n=%i, r=%i, s=%i"
	.align	3
.LC26:
	.string	", st=%i"
	.align	3
...
.LC35:
	...
	.align	3
.LC36:
	.string	"MP+fence.rw.rw+po, sum_hist"
	.align	3
.LC37:
	.string	"Test MP+fence.rw.rw+po Allowed\n"
	.align	3
.LC38:
	.string	"Histogram (%d states)\n"
	.align	3
.LC39:
	.string	"Observation MP+fence.rw.rw+po %s %lu %lu\n"
	.align	3
.LC41:
	.string	"Time MP+fence.rw.rw+po %.2f\n"
	.align	3
.LC42:
	.string	"Ok"
	.align	3
...
.LC45:
	...
	.align	3
.LC46:
	.string	"Hash=2f6175abb7e9850adc52043327dcc10e\n"
	.align	3
.LC47:
	.string	"Cycle=Rfe PodRR Fre Fence.rw.rwdWW\n"
	.align	3
.LC48:
	.string	"PodRR"
	.align	3
.LC49:
	.string	"Relax MP+fence.rw.rw+po %s %s\n"
	.align	3
.LC50:
...
.LC52:
	...
	.align	3
.LC53:
	.string	"Orig=Fence.rw.rwdWW Rfe PodRR Fre\n"
	.align	3
.LC54:
	.string	"No"
	.align	3
...
.LC56:
	...
	.text
	.align	1
	.globl	MP_2B_fence_2E_rw_2E_rw_2B_po
	.type	MP_2B_fence_2E_rw_2E_rw_2B_po, @function
MP_2B_fence_2E_rw_2E_rw_2B_po:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	MP_2B_fence_2E_rw_2E_rw_2B_po, .-MP_2B_fence_2E_rw_2E_rw_2B_po
	.section	.rodata.str1.8
	.align	3
.LC57:
	.string	"[[0],[1]]"
