...
.L2:
	...
	.align	3
.LC1:
	.string	"S+rfi-ctrl+addr, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+rfi-ctrl+addr, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/Rfi/S+rfi-ctrl+addr.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+rfi-ctrl+addr"
	.align	3
.LC13:
	.string	"\"Rfi DpCtrldW Rfe DpAddrdW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC28:
	...
	.align	3
.LC29:
	.string	"S+rfi-ctrl+addr: n=%i, r=%i, s=%i"
	.align	3
.LC30:
	.string	", st=%i"
	.align	3
...
.LC39:
	...
	.align	3
.LC40:
	.string	"S+rfi-ctrl+addr, sum_hist"
	.align	3
.LC41:
	.string	"Test S+rfi-ctrl+addr Allowed\n"
	.align	3
.LC42:
	.string	"Histogram (%d states)\n"
	.align	3
.LC43:
	.string	"Observation S+rfi-ctrl+addr %s %lu %lu\n"
	.align	3
.LC45:
	.string	"Time S+rfi-ctrl+addr %.2f\n"
	.align	3
.LC46:
	.string	"Ok"
	.align	3
...
.LC49:
	...
	.align	3
.LC50:
	.string	"Hash=da5cdff9e7f8348a7e179ea985133a23\n"
	.align	3
.LC51:
	.string	"Cycle=Rfi DpCtrldW Rfe DpAddrdW Wse\n"
	.align	3
.LC52:
	.string	"Rfi"
	.align	3
.LC53:
	.string	"Relax S+rfi-ctrl+addr %s %s\n"
	.align	3
.LC54:
...
.LC56:
	...
	.align	3
.LC57:
	.string	"Orig=Rfi DpCtrldW Rfe DpAddrdW Wse\n"
	.align	3
.LC58:
	.string	"No"
	.align	3
...
.LC60:
	...
	.text
	.align	1
	.globl	S_2B_rfi_2D_ctrl_2B_addr
	.type	S_2B_rfi_2D_ctrl_2B_addr, @function
S_2B_rfi_2D_ctrl_2B_addr:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L235:
	call	__stack_chk_fail@plt
	.size	S_2B_rfi_2D_ctrl_2B_addr, .-S_2B_rfi_2D_ctrl_2B_addr
	.section	.rodata.str1.8
	.align	3
.LC61:
	.string	"[[0],[1]]"
