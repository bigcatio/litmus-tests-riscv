...
.L2:
	...
	.align	3
.LC1:
	.string	"S+fence.i+ctrlfencei, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+fence.i+ctrlfencei, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/Fence.idWW/S+fence.i+ctrlfencei.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+fence.i+ctrlfencei"
	.align	3
.LC13:
	.string	"\"Fence.idWW Rfe DpCtrlFenceIdW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC28:
	...
	.align	3
.LC29:
	.string	"S+fence.i+ctrlfencei: n=%i, r=%i, s=%i"
	.align	3
.LC30:
	.string	", st=%i"
	.align	3
...
.LC39:
	...
	.align	3
.LC40:
	.string	"S+fence.i+ctrlfencei, sum_hist"
	.align	3
.LC41:
	.string	"Test S+fence.i+ctrlfencei Allowed\n"
	.align	3
.LC42:
	.string	"Histogram (%d states)\n"
	.align	3
.LC43:
	.string	"Observation S+fence.i+ctrlfencei %s %lu %lu\n"
	.align	3
.LC45:
	.string	"Time S+fence.i+ctrlfencei %.2f\n"
	.align	3
.LC46:
	.string	"Ok"
	.align	3
...
.LC49:
	...
	.align	3
.LC50:
	.string	"Hash=24a81aa317e75a11c7bf359fbd3ff8b2\n"
	.align	3
.LC51:
	.string	"Cycle=Rfe DpCtrlFenceIdW Wse Fence.idWW\n"
	.align	3
.LC52:
	.string	"Fence.idWW"
	.align	3
.LC53:
	.string	"Relax S+fence.i+ctrlfencei %s %s\n"
	.align	3
.LC54:
...
.LC56:
	...
	.align	3
.LC57:
	.string	"Orig=Fence.idWW Rfe DpCtrlFenceIdW Wse\n"
	.align	3
.LC58:
	.string	"No"
	.align	3
...
.LC60:
	...
	.text
	.align	1
	.globl	S_2B_fence_2E_i_2B_ctrlfencei
	.type	S_2B_fence_2E_i_2B_ctrlfencei, @function
S_2B_fence_2E_i_2B_ctrlfencei:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_fence_2E_i_2B_ctrlfencei, .-S_2B_fence_2E_i_2B_ctrlfencei
	.section	.rodata.str1.8
	.align	3
.LC61:
	.string	"[[0],[1]]"
