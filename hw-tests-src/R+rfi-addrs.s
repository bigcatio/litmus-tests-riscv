...
.L2:
	...
	.align	3
.LC1:
	.string	"R+rfi-addrs, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"R+rfi-addrs, global y unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/Rfi/R+rfi-addrs.litmus %"
	.align	3
.LC12:
	.string	"RISCV R+rfi-addrs"
	.align	3
.LC13:
	.string	"\"Rfi DpAddrdW Wse Rfi DpAddrdR Fre\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC21:
	...
	.align	3
.LC22:
	.string	" add x10,x9,x8 | add x11,x10,x8 ;"
	.align	3
.LC23:
	.string	" sw x5,0(x10)  | lw x9,0(x11)   ;"
	.align	3
.LC24:
	.string	""
	.align	3
...
.LC28:
	...
	.align	3
.LC29:
	.string	"R+rfi-addrs: n=%i, r=%i, s=%i"
	.align	3
.LC30:
	.string	", st=%i"
	.align	3
...
.LC39:
	...
	.align	3
.LC40:
	.string	"R+rfi-addrs, sum_hist"
	.align	3
.LC41:
	.string	"Test R+rfi-addrs Allowed\n"
	.align	3
.LC42:
	.string	"Histogram (%d states)\n"
	.align	3
.LC43:
	.string	"Observation R+rfi-addrs %s %lu %lu\n"
	.align	3
.LC45:
	.string	"Time R+rfi-addrs %.2f\n"
	.align	3
.LC46:
	.string	"Ok"
	.align	3
...
.LC49:
	...
	.align	3
.LC50:
	.string	"Hash=c1799da27ff74e39938513e4e118f214\n"
	.align	3
.LC51:
	.string	"Cycle=Rfi DpAddrdW Wse Rfi DpAddrdR Fre\n"
	.align	3
.LC52:
	.string	"Rfi"
	.align	3
.LC53:
	.string	"Relax R+rfi-addrs %s %s\n"
	.align	3
.LC54:
	.string	"Safe=Fre Wse DpAddrdW DpAddrdR\n"
	.align	3
.LC55:
...
.LC56:
	...
	.align	3
.LC57:
	.string	"Orig=Rfi DpAddrdW Wse Rfi DpAddrdR Fre\n"
	.align	3
.LC58:
	.string	"No"
	.align	3
...
.LC60:
	...
	.text
	.align	1
	.globl	R_2B_rfi_2D_addrs
	.type	R_2B_rfi_2D_addrs, @function
R_2B_rfi_2D_addrs:
	addi	sp,sp,-528
	sd	s0,512(sp)
	sd	s1,504(sp)
...
.L238:
	call	__stack_chk_fail@plt
	.size	R_2B_rfi_2D_addrs, .-R_2B_rfi_2D_addrs
	.section	.rodata.str1.8
	.align	3
.LC61:
	.string	"[[0],[1]]"
