...
/* Show parameters to user */
  if (prm.verbose) {
    log_error( "LB: n=%i, r=%i, s=%i",n_exe,prm.max_run,prm.size_of_test);
...
int LB(int argc, char **argv, FILE *out) {
