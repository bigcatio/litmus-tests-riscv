...
.L2:
	...
	.align	3
.LC1:
	.string	"2+2W+fence.tsos, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"2+2W+fence.tsos, global x unstabilized"
	.align	3
.LC6:
	.string	"2+2W+fence.tsos, global y unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC11:
	...
	.align	3
.LC12:
	.string	"% Results for tests/non-mixed-size/FENCE.TSO/2/2+2W+fence.tsos.litmus %"
	.align	3
.LC13:
	.string	"RISCV 2+2W+fence.tsos"
	.align	3
.LC14:
	.string	"\"Fence.tsodWW Wse Fence.tsodWW Wse\""
	.align	3
.LC15:
	.string	"{"
	.align	3
...
.LC27:
	...
	.align	3
.LC28:
	.string	"2+2W+fence.tsos: n=%i, r=%i, s=%i"
	.align	3
.LC29:
	.string	", st=%i"
	.align	3
...
.LC38:
	...
	.align	3
.LC39:
	.string	"2+2W+fence.tsos, sum_hist"
	.align	3
.LC40:
	.string	"Test 2+2W+fence.tsos Allowed\n"
	.align	3
.LC41:
	.string	"Histogram (%d states)\n"
	.align	3
.LC42:
	.string	"Observation 2+2W+fence.tsos %s %lu %lu\n"
	.align	3
.LC44:
	.string	"Time 2+2W+fence.tsos %.2f\n"
	.align	3
.LC45:
	.string	"Ok"
	.align	3
...
.LC48:
	...
	.align	3
.LC49:
	.string	"Hash=afc3fc1218952157f4ea22774e489e4c\n"
	.align	3
.LC50:
	.string	"Cycle=Wse Fence.tsodWW Wse Fence.tsodWW\n"
	.align	3
.LC51:
	.string	"Relax 2+2W+fence.tsos %s %s\n"
	.align	3
.LC52:
	.string	"Safe=Wse Fence.tsodWW\n"
	.align	3
.LC53:
...
.LC54:
	...
	.align	3
.LC55:
	.string	"Orig=Fence.tsodWW Wse Fence.tsodWW Wse\n"
	.align	3
.LC56:
	.string	"No"
	.align	3
...
.LC58:
	...
	.text
	.align	1
	.globl	_X2_2B_2W_2B_fence_2E_tsos
	.type	_X2_2B_2W_2B_fence_2E_tsos, @function
_X2_2B_2W_2B_fence_2E_tsos:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L236:
	call	__stack_chk_fail@plt
	.size	_X2_2B_2W_2B_fence_2E_tsos, .-_X2_2B_2W_2B_fence_2E_tsos
	.section	.rodata.str1.8
	.align	3
.LC59:
	.string	"[[0],[1]]"
