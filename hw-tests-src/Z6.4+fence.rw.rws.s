...
.L2:
	...
	.align	3
.LC1:
	.string	"Z6.4+fence.rw.rws, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"Z6.4+fence.rw.rws, global y unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/SAFE/Z6.4+fence.rw.rws.litmus %"
	.align	3
.LC12:
	.string	"RISCV Z6.4+fence.rw.rws"
	.align	3
.LC13:
	.string	"\"Fence.rw.rwdWW Wse Fence.rw.rwdWR Fre Fence.rw.rwdWR Fre\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC27:
	...
	.align	3
.LC28:
	.string	"Z6.4+fence.rw.rws: n=%i, r=%i, s=%i"
	.align	3
.LC29:
	.string	", st=%i"
	.align	3
...
.LC38:
	...
	.align	3
.LC39:
	.string	"Z6.4+fence.rw.rws, sum_hist"
	.align	3
.LC40:
	.string	"Test Z6.4+fence.rw.rws Allowed\n"
	.align	3
.LC41:
	.string	"Histogram (%d states)\n"
	.align	3
.LC42:
	.string	"Observation Z6.4+fence.rw.rws %s %lu %lu\n"
	.align	3
.LC44:
	.string	"Time Z6.4+fence.rw.rws %.2f\n"
	.align	3
.LC45:
	.string	"Ok"
	.align	3
...
.LC48:
	...
	.align	3
.LC49:
	.string	"Hash=f4645ef1763493a612f635ca961d482c\n"
	.align	3
.LC50:
	.string	"Cycle=Fre Fence.rw.rwdWW Wse Fence.rw.rwdWR Fre Fence.rw.rwdWR\n"
	.align	3
.LC51:
	.string	"Relax Z6.4+fence.rw.rws %s %s\n"
	.align	3
.LC52:
...
.LC54:
	...
	.align	3
.LC55:
	.string	"Orig=Fence.rw.rwdWW Wse Fence.rw.rwdWR Fre Fence.rw.rwdWR Fre\n"
	.align	3
.LC56:
	.string	"No"
	.align	3
...
.LC58:
	...
	.text
	.align	1
	.globl	Z6_2E_4_2B_fence_2E_rw_2E_rws
	.type	Z6_2E_4_2B_fence_2E_rw_2E_rws, @function
Z6_2E_4_2B_fence_2E_rw_2E_rws:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L266:
	call	__stack_chk_fail@plt
	.size	Z6_2E_4_2B_fence_2E_rw_2E_rws, .-Z6_2E_4_2B_fence_2E_rw_2E_rws
	.section	.rodata.str1.8
	.align	3
.LC59:
	.string	"[[1,2],[0]]"
