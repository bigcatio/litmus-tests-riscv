...
.L2:
	...
	.align	3
.LC1:
	.string	"S+fence.i+addr, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+fence.i+addr, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/Fence.idWW/S+fence.i+addr.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+fence.i+addr"
	.align	3
.LC13:
	.string	"\"Fence.idWW Rfe DpAddrdW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC27:
	...
	.align	3
.LC28:
	.string	"S+fence.i+addr: n=%i, r=%i, s=%i"
	.align	3
.LC29:
	.string	", st=%i"
	.align	3
...
.LC38:
	...
	.align	3
.LC39:
	.string	"S+fence.i+addr, sum_hist"
	.align	3
.LC40:
	.string	"Test S+fence.i+addr Allowed\n"
	.align	3
.LC41:
	.string	"Histogram (%d states)\n"
	.align	3
.LC42:
	.string	"Observation S+fence.i+addr %s %lu %lu\n"
	.align	3
.LC44:
	.string	"Time S+fence.i+addr %.2f\n"
	.align	3
.LC45:
	.string	"Ok"
	.align	3
...
.LC48:
	...
	.align	3
.LC49:
	.string	"Hash=e3dc2bd7cabc2f818173f9032c6605c4\n"
	.align	3
.LC50:
	.string	"Cycle=Rfe DpAddrdW Wse Fence.idWW\n"
	.align	3
.LC51:
	.string	"Fence.idWW"
	.align	3
.LC52:
	.string	"Relax S+fence.i+addr %s %s\n"
	.align	3
.LC53:
...
.LC55:
	...
	.align	3
.LC56:
	.string	"Orig=Fence.idWW Rfe DpAddrdW Wse\n"
	.align	3
.LC57:
	.string	"No"
	.align	3
...
.LC59:
	...
	.text
	.align	1
	.globl	S_2B_fence_2E_i_2B_addr
	.type	S_2B_fence_2E_i_2B_addr, @function
S_2B_fence_2E_i_2B_addr:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_fence_2E_i_2B_addr, .-S_2B_fence_2E_i_2B_addr
	.section	.rodata.str1.8
	.align	3
.LC60:
	.string	"[[0],[1]]"
