...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+fence.r.rws, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/Fence.r.rwdWW/MP+fence.r.rws.litmus %"
	.align	3
.LC10:
	.string	"RISCV MP+fence.r.rws"
	.align	3
.LC11:
	.string	"\"Fence.r.rwdWW Rfe Fence.r.rwdRR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC24:
	...
	.align	3
.LC25:
	.string	"MP+fence.r.rws: n=%i, r=%i, s=%i"
	.align	3
.LC26:
	.string	", st=%i"
	.align	3
...
.LC35:
	...
	.align	3
.LC36:
	.string	"MP+fence.r.rws, sum_hist"
	.align	3
.LC37:
	.string	"Test MP+fence.r.rws Allowed\n"
	.align	3
.LC38:
	.string	"Histogram (%d states)\n"
	.align	3
.LC39:
	.string	"Observation MP+fence.r.rws %s %lu %lu\n"
	.align	3
.LC41:
	.string	"Time MP+fence.r.rws %.2f\n"
	.align	3
.LC42:
	.string	"Ok"
	.align	3
...
.LC45:
	...
	.align	3
.LC46:
	.string	"Hash=fb890e134d99b5978b6e27085658c032\n"
	.align	3
.LC47:
	.string	"Cycle=Rfe Fence.r.rwdRR Fre Fence.r.rwdWW\n"
	.align	3
.LC48:
	.string	"Fence.r.rwdWW"
	.align	3
.LC49:
	.string	"Relax MP+fence.r.rws %s %s\n"
	.align	3
.LC50:
...
.LC52:
	...
	.align	3
.LC53:
	.string	"Orig=Fence.r.rwdWW Rfe Fence.r.rwdRR Fre\n"
	.align	3
.LC54:
	.string	"No"
	.align	3
...
.LC56:
	...
	.text
	.align	1
	.globl	MP_2B_fence_2E_r_2E_rws
	.type	MP_2B_fence_2E_r_2E_rws, @function
MP_2B_fence_2E_r_2E_rws:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	MP_2B_fence_2E_r_2E_rws, .-MP_2B_fence_2E_r_2E_rws
	.section	.rodata.str1.8
	.align	3
.LC57:
	.string	"[[0],[1]]"
