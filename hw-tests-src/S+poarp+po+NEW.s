...
.L2:
	...
	.align	3
.LC1:
	.string	"S+poarp+po+NEW, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+poarp+po+NEW, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/AMO_X0_2_THREAD/S+poarp+po+NEW.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+poarp+po+NEW"
	.align	3
.LC13:
	.string	"\"PodWWARP Rfe PodRW WsePAR\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC25:
	...
	.align	3
.LC26:
	.string	"S+poarp+po+NEW: n=%i, r=%i, s=%i"
	.align	3
.LC27:
	.string	", st=%i"
	.align	3
...
.LC36:
	...
	.align	3
.LC37:
	.string	"S+poarp+po+NEW, sum_hist"
	.align	3
.LC38:
	.string	"Test S+poarp+po+NEW Allowed\n"
	.align	3
.LC39:
	.string	"Histogram (%d states)\n"
	.align	3
.LC40:
	.string	"Observation S+poarp+po+NEW %s %lu %lu\n"
	.align	3
.LC42:
	.string	"Time S+poarp+po+NEW %.2f\n"
	.align	3
.LC43:
	.string	"Ok"
	.align	3
...
.LC46:
	...
	.align	3
.LC47:
	.string	"Hash=4c5d39b144f76f13b23ac6dd2492919d\n"
	.align	3
.LC48:
	.string	"Cycle=Rfe PodRW WsePAR PodWWARP\n"
	.align	3
.LC49:
	.string	"AR"
	.align	3
.LC50:
	.string	"Relax S+poarp+po+NEW %s %s\n"
	.align	3
.LC51:
...
.LC53:
	...
	.align	3
.LC54:
	.string	"Orig=PodWWARP Rfe PodRW WsePAR\n"
	.align	3
.LC55:
	.string	"No"
	.align	3
...
.LC57:
	...
	.text
	.align	1
	.globl	S_2B_poarp_2B_po_2B_NEW
	.type	S_2B_poarp_2B_po_2B_NEW, @function
S_2B_poarp_2B_po_2B_NEW:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_poarp_2B_po_2B_NEW, .-S_2B_poarp_2B_po_2B_NEW
	.section	.rodata.str1.8
	.align	3
.LC58:
	.string	"[[0],[1]]"
