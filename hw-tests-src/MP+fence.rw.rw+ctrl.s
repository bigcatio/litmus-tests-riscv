...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+fence.rw.rw+ctrl, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/DpCtrldR/MP+fence.rw.rw+ctrl.litmus %"
	.align	3
.LC10:
	.string	"RISCV MP+fence.rw.rw+ctrl"
	.align	3
.LC11:
	.string	"\"Fence.rw.rwdWW Rfe DpCtrldR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC25:
	...
	.align	3
.LC26:
	.string	"MP+fence.rw.rw+ctrl: n=%i, r=%i, s=%i"
	.align	3
.LC27:
	.string	", st=%i"
	.align	3
...
.LC36:
	...
	.align	3
.LC37:
	.string	"MP+fence.rw.rw+ctrl, sum_hist"
	.align	3
.LC38:
	.string	"Test MP+fence.rw.rw+ctrl Allowed\n"
	.align	3
.LC39:
	.string	"Histogram (%d states)\n"
	.align	3
.LC40:
	.string	"Observation MP+fence.rw.rw+ctrl %s %lu %lu\n"
	.align	3
.LC42:
	.string	"Time MP+fence.rw.rw+ctrl %.2f\n"
	.align	3
.LC43:
	.string	"Ok"
	.align	3
...
.LC46:
	...
	.align	3
.LC47:
	.string	"Hash=51ecc10877d4b4f57d8b431de41bd8b2\n"
	.align	3
.LC48:
	.string	"Cycle=Rfe DpCtrldR Fre Fence.rw.rwdWW\n"
	.align	3
.LC49:
	.string	"DpCtrldR"
	.align	3
.LC50:
	.string	"Relax MP+fence.rw.rw+ctrl %s %s\n"
	.align	3
.LC51:
...
.LC53:
	...
	.align	3
.LC54:
	.string	"Orig=Fence.rw.rwdWW Rfe DpCtrldR Fre\n"
	.align	3
.LC55:
	.string	"No"
	.align	3
...
.LC57:
	...
	.text
	.align	1
	.globl	MP_2B_fence_2E_rw_2E_rw_2B_ctrl
	.type	MP_2B_fence_2E_rw_2E_rw_2B_ctrl, @function
MP_2B_fence_2E_rw_2E_rw_2B_ctrl:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	MP_2B_fence_2E_rw_2E_rw_2B_ctrl, .-MP_2B_fence_2E_rw_2E_rw_2B_ctrl
	.section	.rodata.str1.8
	.align	3
.LC58:
	.string	"[[0],[1]]"
