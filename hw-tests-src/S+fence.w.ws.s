...
.L2:
	...
	.align	3
.LC1:
	.string	"S+fence.w.ws, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+fence.w.ws, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/Fence.w.wdRW/S+fence.w.ws.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+fence.w.ws"
	.align	3
.LC13:
	.string	"\"Fence.w.wdWW Rfe Fence.w.wdRW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC26:
	...
	.align	3
.LC27:
	.string	"S+fence.w.ws: n=%i, r=%i, s=%i"
	.align	3
.LC28:
	.string	", st=%i"
	.align	3
...
.LC37:
	...
	.align	3
.LC38:
	.string	"S+fence.w.ws, sum_hist"
	.align	3
.LC39:
	.string	"Test S+fence.w.ws Allowed\n"
	.align	3
.LC40:
	.string	"Histogram (%d states)\n"
	.align	3
.LC41:
	.string	"Observation S+fence.w.ws %s %lu %lu\n"
	.align	3
.LC43:
	.string	"Time S+fence.w.ws %.2f\n"
	.align	3
.LC44:
	.string	"Ok"
	.align	3
...
.LC47:
	...
	.align	3
.LC48:
	.string	"Hash=4eb3767d375989211f8560ce771f050b\n"
	.align	3
.LC49:
	.string	"Cycle=Rfe Fence.w.wdRW Wse Fence.w.wdWW\n"
	.align	3
.LC50:
	.string	"Fence.w.wdRW"
	.align	3
.LC51:
	.string	"Relax S+fence.w.ws %s %s\n"
	.align	3
.LC52:
...
.LC54:
	...
	.align	3
.LC55:
	.string	"Orig=Fence.w.wdWW Rfe Fence.w.wdRW Wse\n"
	.align	3
.LC56:
	.string	"No"
	.align	3
...
.LC58:
	...
	.text
	.align	1
	.globl	S_2B_fence_2E_w_2E_ws
	.type	S_2B_fence_2E_w_2E_ws, @function
S_2B_fence_2E_w_2E_ws:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_fence_2E_w_2E_ws, .-S_2B_fence_2E_w_2E_ws
	.section	.rodata.str1.8
	.align	3
.LC59:
	.string	"[[0],[1]]"
