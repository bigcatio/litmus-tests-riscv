...
.L2:
	...
	.align	3
.LC1:
	.string	"S+fence.rw.w+po, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+fence.rw.w+po, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/PodRW/S+fence.rw.w+po.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+fence.rw.w+po"
	.align	3
.LC13:
	.string	"\"Fence.rw.wdWW Rfe PodRW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC26:
	...
	.align	3
.LC27:
	.string	"S+fence.rw.w+po: n=%i, r=%i, s=%i"
	.align	3
.LC28:
	.string	", st=%i"
	.align	3
...
.LC37:
	...
	.align	3
.LC38:
	.string	"S+fence.rw.w+po, sum_hist"
	.align	3
.LC39:
	.string	"Test S+fence.rw.w+po Allowed\n"
	.align	3
.LC40:
	.string	"Histogram (%d states)\n"
	.align	3
.LC41:
	.string	"Observation S+fence.rw.w+po %s %lu %lu\n"
	.align	3
.LC43:
	.string	"Time S+fence.rw.w+po %.2f\n"
	.align	3
.LC44:
	.string	"Ok"
	.align	3
...
.LC47:
	...
	.align	3
.LC48:
	.string	"Hash=040b1e1865214a0f37d555d2803bfcff\n"
	.align	3
.LC49:
	.string	"Cycle=Rfe PodRW Wse Fence.rw.wdWW\n"
	.align	3
.LC50:
	.string	"PodRW"
	.align	3
.LC51:
	.string	"Relax S+fence.rw.w+po %s %s\n"
	.align	3
.LC52:
...
.LC54:
	...
	.align	3
.LC55:
	.string	"Orig=Fence.rw.wdWW Rfe PodRW Wse\n"
	.align	3
.LC56:
	.string	"No"
	.align	3
...
.LC58:
	...
	.text
	.align	1
	.globl	S_2B_fence_2E_rw_2E_w_2B_po
	.type	S_2B_fence_2E_rw_2E_w_2B_po, @function
S_2B_fence_2E_rw_2E_w_2B_po:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_fence_2E_rw_2E_w_2B_po, .-S_2B_fence_2E_rw_2E_w_2B_po
	.section	.rodata.str1.8
	.align	3
.LC59:
	.string	"[[0],[1]]"
