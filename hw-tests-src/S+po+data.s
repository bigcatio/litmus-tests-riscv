...
.L2:
	...
	.align	3
.LC1:
	.string	"S+po+data, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+po+data, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/PodWW/S+po+data.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+po+data"
	.align	3
.LC13:
	.string	"\"PodWW Rfe DpDatadW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC38:
	...
	.align	3
.LC39:
	.string	"S+po+data, sum_hist"
	.align	3
.LC40:
	.string	"Test S+po+data Allowed\n"
	.align	3
.LC41:
	.string	"Histogram (%d states)\n"
	.align	3
.LC42:
	.string	"Observation S+po+data %s %lu %lu\n"
	.align	3
.LC44:
	.string	"Time S+po+data %.2f\n"
	.align	3
.LC45:
	.string	"Ok"
	.align	3
...
.LC48:
	...
	.align	3
.LC49:
	.string	"Hash=cfc58037010f56fd8c45fd430f69a56e\n"
	.align	3
.LC50:
	.string	"Cycle=Rfe DpDatadW Wse PodWW\n"
	.align	3
.LC51:
	.string	"PodWW"
	.align	3
.LC52:
	.string	"Relax S+po+data %s %s\n"
	.align	3
.LC53:
...
.LC55:
	...
	.align	3
.LC56:
	.string	"Orig=PodWW Rfe DpDatadW Wse\n"
	.align	3
.LC57:
	.string	"No"
	.align	3
...
.LC59:
	...
	.text
	.align	1
	.globl	S_2B_po_2B_data
	.type	S_2B_po_2B_data, @function
S_2B_po_2B_data:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L233:
	call	__stack_chk_fail@plt
	.size	S_2B_po_2B_data, .-S_2B_po_2B_data
	.section	.rodata.str1.8
	.align	3
.LC60:
	.string	"[[0],[1]]"
