...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+fence.w.w+po, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/PodRR/MP+fence.w.w+po.litmus %"
	.align	3
.LC10:
	.string	"RISCV MP+fence.w.w+po"
	.align	3
.LC11:
	.string	"\"Fence.w.wdWW Rfe PodRR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC24:
	...
	.align	3
.LC25:
	.string	"MP+fence.w.w+po: n=%i, r=%i, s=%i"
	.align	3
.LC26:
	.string	", st=%i"
	.align	3
...
.LC35:
	...
	.align	3
.LC36:
	.string	"MP+fence.w.w+po, sum_hist"
	.align	3
.LC37:
	.string	"Test MP+fence.w.w+po Allowed\n"
	.align	3
.LC38:
	.string	"Histogram (%d states)\n"
	.align	3
.LC39:
	.string	"Observation MP+fence.w.w+po %s %lu %lu\n"
	.align	3
.LC41:
	.string	"Time MP+fence.w.w+po %.2f\n"
	.align	3
.LC42:
	.string	"Ok"
	.align	3
...
.LC45:
	...
	.align	3
.LC46:
	.string	"Hash=68b8aea1d67d46d7a2443bb812dcfc0e\n"
	.align	3
.LC47:
	.string	"Cycle=Rfe PodRR Fre Fence.w.wdWW\n"
	.align	3
.LC48:
	.string	"PodRR"
	.align	3
.LC49:
	.string	"Relax MP+fence.w.w+po %s %s\n"
	.align	3
.LC50:
...
.LC52:
	...
	.align	3
.LC53:
	.string	"Orig=Fence.w.wdWW Rfe PodRR Fre\n"
	.align	3
.LC54:
	.string	"No"
	.align	3
...
.LC56:
	...
	.text
	.align	1
	.globl	MP_2B_fence_2E_w_2E_w_2B_po
	.type	MP_2B_fence_2E_w_2E_w_2B_po, @function
MP_2B_fence_2E_w_2E_w_2B_po:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	MP_2B_fence_2E_w_2E_w_2B_po, .-MP_2B_fence_2E_w_2E_w_2B_po
	.section	.rodata.str1.8
	.align	3
.LC57:
	.string	"[[0],[1]]"
