...
.L2:
	...
	.align	3
.LC1:
	.string	"S+rfi-ctrlfencei+data, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+rfi-ctrlfencei+data, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/Rfi/S+rfi-ctrlfencei+data.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+rfi-ctrlfencei+data"
	.align	3
.LC13:
	.string	"\"Rfi DpCtrlFenceIdW Rfe DpDatadW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC29:
	...
	.align	3
.LC30:
	.string	"S+rfi-ctrlfencei+data: n=%i, r=%i, s=%i"
	.align	3
.LC31:
	.string	", st=%i"
	.align	3
...
.LC40:
	...
	.align	3
.LC41:
	.string	"S+rfi-ctrlfencei+data, sum_hist"
	.align	3
.LC42:
	.string	"Test S+rfi-ctrlfencei+data Allowed\n"
	.align	3
.LC43:
	.string	"Histogram (%d states)\n"
	.align	3
.LC44:
	.string	"Observation S+rfi-ctrlfencei+data %s %lu %lu\n"
	.align	3
.LC46:
	.string	"Time S+rfi-ctrlfencei+data %.2f\n"
	.align	3
.LC47:
	.string	"Ok"
	.align	3
...
.LC50:
	...
	.align	3
.LC51:
	.string	"Hash=e9b3efb81d12e1d1948a14ca76c1a6af\n"
	.align	3
.LC52:
	.string	"Cycle=Rfi DpCtrlFenceIdW Rfe DpDatadW Wse\n"
	.align	3
.LC53:
	.string	"Rfi"
	.align	3
.LC54:
	.string	"Relax S+rfi-ctrlfencei+data %s %s\n"
	.align	3
.LC55:
...
.LC57:
	...
	.align	3
.LC58:
	.string	"Orig=Rfi DpCtrlFenceIdW Rfe DpDatadW Wse\n"
	.align	3
.LC59:
	.string	"No"
	.align	3
...
.LC61:
	...
	.text
	.align	1
	.globl	S_2B_rfi_2D_ctrlfencei_2B_data
	.type	S_2B_rfi_2D_ctrlfencei_2B_data, @function
S_2B_rfi_2D_ctrlfencei_2B_data:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L235:
	call	__stack_chk_fail@plt
	.size	S_2B_rfi_2D_ctrlfencei_2B_data, .-S_2B_rfi_2D_ctrlfencei_2B_data
	.section	.rodata.str1.8
	.align	3
.LC62:
	.string	"[[0],[1]]"
