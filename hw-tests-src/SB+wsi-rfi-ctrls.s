...
.L2:
	...
	.align	3
.LC1:
	.string	"SB+wsi-rfi-ctrls, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"SB+wsi-rfi-ctrls, global x unstabilized"
	.align	3
.LC6:
	.string	"SB+wsi-rfi-ctrls, global y unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC11:
	...
	.align	3
.LC12:
	.string	"% Results for tests/non-mixed-size/RELAX/Coi-Rfi/SB+wsi-rfi-ctrls.litmus %"
	.align	3
.LC13:
	.string	"RISCV SB+wsi-rfi-ctrls"
	.align	3
.LC14:
	.string	"\"Wsi Rfi DpCtrldR Fre Wsi Rfi DpCtrldR Fre\""
	.align	3
.LC15:
	.string	"{"
	.align	3
...
.LC30:
	...
	.align	3
.LC31:
	.string	"SB+wsi-rfi-ctrls: n=%i, r=%i, s=%i"
	.align	3
.LC32:
	.string	", st=%i"
	.align	3
...
.LC41:
	...
	.align	3
.LC42:
	.string	"SB+wsi-rfi-ctrls, sum_hist"
	.align	3
.LC43:
	.string	"Test SB+wsi-rfi-ctrls Allowed\n"
	.align	3
.LC44:
	.string	"Histogram (%d states)\n"
	.align	3
.LC45:
	.string	"Observation SB+wsi-rfi-ctrls %s %lu %lu\n"
	.align	3
.LC47:
	.string	"Time SB+wsi-rfi-ctrls %.2f\n"
	.align	3
.LC48:
	.string	"Ok"
	.align	3
...
.LC51:
	...
	.align	3
.LC52:
	.string	"Hash=affd25605daaaa79767f1d32ed97f949\n"
	.align	3
.LC53:
	.string	"Cycle=Rfi DpCtrldR Fre Wsi Rfi DpCtrldR Fre Wsi\n"
	.align	3
.LC54:
	.string	"[Wsi,Rfi]"
	.align	3
.LC55:
	.string	"Relax SB+wsi-rfi-ctrls %s %s\n"
	.align	3
.LC56:
	.string	"Safe=Fre DpCtrldR\n"
	.align	3
.LC57:
...
.LC58:
	...
	.align	3
.LC59:
	.string	"Orig=Wsi Rfi DpCtrldR Fre Wsi Rfi DpCtrldR Fre\n"
	.align	3
.LC60:
	.string	"No"
	.align	3
...
.LC62:
	...
	.text
	.align	1
	.globl	SB_2B_wsi_2D_rfi_2D_ctrls
	.type	SB_2B_wsi_2D_rfi_2D_ctrls, @function
SB_2B_wsi_2D_rfi_2D_ctrls:
	addi	sp,sp,-544
	sd	s0,528(sp)
	sd	s1,520(sp)
	sd	s2,512(sp)
...
.L243:
	call	__stack_chk_fail@plt
	.size	SB_2B_wsi_2D_rfi_2D_ctrls, .-SB_2B_wsi_2D_rfi_2D_ctrls
	.section	.rodata.str1.8
	.align	3
.LC63:
	.string	"[[0],[1]]"
