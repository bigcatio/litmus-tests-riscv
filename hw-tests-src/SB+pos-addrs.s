...
.L2:
	...
	.align	3
.LC1:
	.string	"SB+pos-addrs, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/PosWR/SB+pos-addrs.litmus %"
	.align	3
.LC10:
	.string	"RISCV SB+pos-addrs"
	.align	3
.LC11:
	.string	"\"PosWR DpAddrdR Fre PosWR DpAddrdR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC20:
	...
	.align	3
.LC21:
	.string	" lw x9,0(x11)   | lw x9,0(x11)   ;"
	.align	3
.LC22:
	.string	""
	.align	3
...
.LC26:
	...
	.align	3
.LC27:
	.string	"SB+pos-addrs: n=%i, r=%i, s=%i"
	.align	3
.LC28:
	.string	", st=%i"
	.align	3
...
.LC37:
	...
	.align	3
.LC38:
	.string	"SB+pos-addrs, sum_hist"
	.align	3
.LC39:
	.string	"Test SB+pos-addrs Allowed\n"
	.align	3
.LC40:
	.string	"Histogram (%d states)\n"
	.align	3
.LC41:
	.string	"Observation SB+pos-addrs %s %lu %lu\n"
	.align	3
.LC43:
	.string	"Time SB+pos-addrs %.2f\n"
	.align	3
.LC44:
	.string	"Ok"
	.align	3
...
.LC47:
	...
	.align	3
.LC48:
	.string	"Hash=2b1e9852aae486f2a0a95de030240bef\n"
	.align	3
.LC49:
	.string	"Cycle=Fre PosWR DpAddrdR Fre PosWR DpAddrdR\n"
	.align	3
.LC50:
	.string	"PosWR"
	.align	3
.LC51:
	.string	"Relax SB+pos-addrs %s %s\n"
	.align	3
.LC52:
...
.LC54:
	...
	.align	3
.LC55:
	.string	"Orig=PosWR DpAddrdR Fre PosWR DpAddrdR Fre\n"
	.align	3
.LC56:
	.string	"No"
	.align	3
...
.LC58:
	...
	.text
	.align	1
	.globl	SB_2B_pos_2D_addrs
	.type	SB_2B_pos_2D_addrs, @function
SB_2B_pos_2D_addrs:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	SB_2B_pos_2D_addrs, .-SB_2B_pos_2D_addrs
	.section	.rodata.str1.8
	.align	3
.LC59:
	.string	"[[0],[1]]"
