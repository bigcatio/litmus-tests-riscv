...
.L2:
	...
	.align	3
.LC1:
	.string	"3.2W+fence.rw.rws, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"3.2W+fence.rw.rws, global x unstabilized"
	.align	3
.LC6:
	.string	"3.2W+fence.rw.rws, global y unstabilized"
	.align	3
.LC7:
	.string	"3.2W+fence.rw.rws, global z unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC12:
	...
	.align	3
.LC13:
	.string	"% Results for tests/non-mixed-size/SAFE/3.2W+fence.rw.rws.litmus %"
	.align	3
.LC14:
	.string	"RISCV 3.2W+fence.rw.rws"
	.align	3
.LC15:
	.string	"\"Fence.rw.rwdWW Wse Fence.rw.rwdWW Wse Fence.rw.rwdWW Wse\""
	.align	3
.LC16:
	.string	"{"
	.align	3
...
.LC29:
	...
	.align	3
.LC30:
	.string	"3.2W+fence.rw.rws: n=%i, r=%i, s=%i"
	.align	3
.LC31:
	.string	", st=%i"
	.align	3
...
.LC40:
	...
	.align	3
.LC41:
	.string	"3.2W+fence.rw.rws, sum_hist"
	.align	3
.LC42:
	.string	"Test 3.2W+fence.rw.rws Allowed\n"
	.align	3
.LC43:
	.string	"Histogram (%d states)\n"
	.align	3
.LC44:
	.string	"Observation 3.2W+fence.rw.rws %s %lu %lu\n"
	.align	3
.LC46:
	.string	"Time 3.2W+fence.rw.rws %.2f\n"
	.align	3
.LC47:
	.string	"Ok"
	.align	3
...
.LC50:
	...
	.align	3
.LC51:
	.string	"Hash=56561053b91d2cc7cda9519589997a47\n"
	.align	3
.LC52:
	.string	"Cycle=Wse Fence.rw.rwdWW Wse Fence.rw.rwdWW Wse Fence.rw.rwdWW\n"
	.align	3
.LC53:
	.string	"Relax 3.2W+fence.rw.rws %s %s\n"
	.align	3
.LC54:
...
.LC56:
	...
	.align	3
.LC57:
	.string	"Orig=Fence.rw.rwdWW Wse Fence.rw.rwdWW Wse Fence.rw.rwdWW Wse\n"
	.align	3
.LC58:
	.string	"No"
	.align	3
...
.LC60:
	...
	.text
	.align	1
	.globl	_X3_2E_2W_2B_fence_2E_rw_2E_rws
	.type	_X3_2E_2W_2B_fence_2E_rw_2E_rws, @function
_X3_2E_2W_2B_fence_2E_rw_2E_rws:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L282:
	call	__stack_chk_fail@plt
	.size	_X3_2E_2W_2B_fence_2E_rw_2E_rws, .-_X3_2E_2W_2B_fence_2E_rw_2E_rws
	.section	.rodata.str1.8
	.align	3
.LC61:
	.string	"[[1,2],[0]]"
