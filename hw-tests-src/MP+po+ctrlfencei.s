...
.L2:
	...
	.align	3
.LC1:
	.string	"MP+po+ctrlfencei, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/PodWW/MP+po+ctrlfencei.litmus %"
	.align	3
.LC10:
	.string	"RISCV MP+po+ctrlfencei"
	.align	3
.LC11:
	.string	"\"PodWW Rfe DpCtrlFenceIdR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC17:
	...
	.align	3
.LC18:
	.string	" sw x5,0(x7) | bne x5,x0,LC00 ;"
	.align	3
.LC19:
	.string	"             | LC00:          ;"
	.align	3
...
.LC26:
	...
	.align	3
.LC27:
	.string	"MP+po+ctrlfencei: n=%i, r=%i, s=%i"
	.align	3
.LC28:
	.string	", st=%i"
	.align	3
...
.LC37:
	...
	.align	3
.LC38:
	.string	"MP+po+ctrlfencei, sum_hist"
	.align	3
.LC39:
	.string	"Test MP+po+ctrlfencei Allowed\n"
	.align	3
.LC40:
	.string	"Histogram (%d states)\n"
	.align	3
.LC41:
	.string	"Observation MP+po+ctrlfencei %s %lu %lu\n"
	.align	3
.LC43:
	.string	"Time MP+po+ctrlfencei %.2f\n"
	.align	3
.LC44:
	.string	"Ok"
	.align	3
...
.LC47:
	...
	.align	3
.LC48:
	.string	"Hash=4fc8bc96b474143b05fc0ae546a9301b\n"
	.align	3
.LC49:
	.string	"Cycle=Rfe DpCtrlFenceIdR Fre PodWW\n"
	.align	3
.LC50:
	.string	"PodWW"
	.align	3
.LC51:
	.string	"Relax MP+po+ctrlfencei %s %s\n"
	.align	3
.LC52:
...
.LC54:
	...
	.align	3
.LC55:
	.string	"Orig=PodWW Rfe DpCtrlFenceIdR Fre\n"
	.align	3
.LC56:
	.string	"No"
	.align	3
...
.LC58:
	...
	.text
	.align	1
	.globl	MP_2B_po_2B_ctrlfencei
	.type	MP_2B_po_2B_ctrlfencei, @function
MP_2B_po_2B_ctrlfencei:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	MP_2B_po_2B_ctrlfencei, .-MP_2B_po_2B_ctrlfencei
	.section	.rodata.str1.8
	.align	3
.LC59:
	.string	"[[0],[1]]"
