...
.L2:
	...
	.align	3
.LC1:
	.string	"2+2W+fence.rw.rw+po, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"2+2W+fence.rw.rw+po, global x unstabilized"
	.align	3
.LC6:
	.string	"2+2W+fence.rw.rw+po, global y unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC11:
	...
	.align	3
.LC12:
	.string	"% Results for tests/non-mixed-size/RELAX/PodWW/2+2W+fence.rw.rw+po.litmus %"
	.align	3
.LC13:
	.string	"RISCV 2+2W+fence.rw.rw+po"
	.align	3
.LC14:
	.string	"\"Fence.rw.rwdWW Wse PodWW Wse\""
	.align	3
.LC15:
	.string	"{"
	.align	3
...
.LC27:
	...
	.align	3
.LC28:
	.string	"2+2W+fence.rw.rw+po: n=%i, r=%i, s=%i"
	.align	3
.LC29:
	.string	", st=%i"
	.align	3
...
.LC38:
	...
	.align	3
.LC39:
	.string	"2+2W+fence.rw.rw+po, sum_hist"
	.align	3
.LC40:
	.string	"Test 2+2W+fence.rw.rw+po Allowed\n"
	.align	3
.LC41:
	.string	"Histogram (%d states)\n"
	.align	3
.LC42:
	.string	"Observation 2+2W+fence.rw.rw+po %s %lu %lu\n"
	.align	3
.LC44:
	.string	"Time 2+2W+fence.rw.rw+po %.2f\n"
	.align	3
.LC45:
	.string	"Ok"
	.align	3
...
.LC48:
	...
	.align	3
.LC49:
	.string	"Hash=b025d64fbd3e1907a271ab0019e1d572\n"
	.align	3
.LC50:
	.string	"Cycle=Wse PodWW Wse Fence.rw.rwdWW\n"
	.align	3
.LC51:
	.string	"PodWW"
	.align	3
.LC52:
	.string	"Relax 2+2W+fence.rw.rw+po %s %s\n"
	.align	3
.LC53:
...
.LC55:
	...
	.align	3
.LC56:
	.string	"Orig=Fence.rw.rwdWW Wse PodWW Wse\n"
	.align	3
.LC57:
	.string	"No"
	.align	3
...
.LC59:
	...
	.text
	.align	1
	.globl	_X2_2B_2W_2B_fence_2E_rw_2E_rw_2B_po
	.type	_X2_2B_2W_2B_fence_2E_rw_2E_rw_2B_po, @function
_X2_2B_2W_2B_fence_2E_rw_2E_rw_2B_po:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L236:
	call	__stack_chk_fail@plt
	.size	_X2_2B_2W_2B_fence_2E_rw_2E_rw_2B_po, .-_X2_2B_2W_2B_fence_2E_rw_2E_rw_2B_po
	.section	.rodata.str1.8
	.align	3
.LC60:
	.string	"[[0],[1]]"
