...
.L2:
	...
	.align	3
.LC1:
	.string	"LB+addr+po, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/PodRW/LB+addr+po.litmus %"
	.align	3
.LC10:
	.string	"RISCV LB+addr+po"
	.align	3
.LC11:
	.string	"\"DpAddrdW Rfe PodRW Rfe\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC17:
	...
	.align	3
.LC18:
	.string	" xor x7,x5,x5  | sw x7,0(x8) ;"
	.align	3
.LC19:
	.string	" add x10,x9,x7 |             ;"
	.align	3
.LC20:
	.string	" sw x8,0(x10)  |             ;"
	.align	3
...
.LC36:
	...
	.align	3
.LC37:
	.string	"LB+addr+po, sum_hist"
	.align	3
.LC38:
	.string	"Test LB+addr+po Allowed\n"
	.align	3
.LC39:
	.string	"Histogram (%d states)\n"
	.align	3
.LC40:
	.string	"Observation LB+addr+po %s %lu %lu\n"
	.align	3
.LC42:
	.string	"Time LB+addr+po %.2f\n"
	.align	3
.LC43:
	.string	"Ok"
	.align	3
...
.LC46:
	...
	.align	3
.LC47:
	.string	"Hash=9ff1ad537338a8d9c5cc1c4131c9195a\n"
	.align	3
.LC48:
	.string	"Cycle=Rfe PodRW Rfe DpAddrdW\n"
	.align	3
.LC49:
	.string	"PodRW"
	.align	3
.LC50:
	.string	"Relax LB+addr+po %s %s\n"
	.align	3
.LC51:
...
.LC53:
	...
	.align	3
.LC54:
	.string	"Orig=DpAddrdW Rfe PodRW Rfe\n"
	.align	3
.LC55:
	.string	"No"
	.align	3
...
.LC57:
	...
	.text
	.align	1
	.globl	LB_2B_addr_2B_po
	.type	LB_2B_addr_2B_po, @function
LB_2B_addr_2B_po:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	LB_2B_addr_2B_po, .-LB_2B_addr_2B_po
	.section	.rodata.str1.8
	.align	3
.LC58:
	.string	"[[0],[1]]"
