...
.L2:
	...
	.align	3
.LC1:
	.string	"SB+fence.is, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/Fence.idWR/SB+fence.is.litmus %"
	.align	3
.LC10:
	.string	"RISCV SB+fence.is"
	.align	3
.LC11:
	.string	"\"Fence.idWR Fre Fence.idWR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC24:
	...
	.align	3
.LC25:
	.string	"SB+fence.is: n=%i, r=%i, s=%i"
	.align	3
.LC26:
	.string	", st=%i"
	.align	3
...
.LC35:
	...
	.align	3
.LC36:
	.string	"SB+fence.is, sum_hist"
	.align	3
.LC37:
	.string	"Test SB+fence.is Allowed\n"
	.align	3
.LC38:
	.string	"Histogram (%d states)\n"
	.align	3
.LC39:
	.string	"Observation SB+fence.is %s %lu %lu\n"
	.align	3
.LC41:
	.string	"Time SB+fence.is %.2f\n"
	.align	3
.LC42:
	.string	"Ok"
	.align	3
...
.LC45:
	...
	.align	3
.LC46:
	.string	"Hash=2588de971438b5b24ebff6007c7b51a7\n"
	.align	3
.LC47:
	.string	"Cycle=Fre Fence.idWR Fre Fence.idWR\n"
	.align	3
.LC48:
	.string	"Fence.idWR"
	.align	3
.LC49:
	.string	"Relax SB+fence.is %s %s\n"
	.align	3
.LC50:
	.string	"Safe=Fre\n"
	.align	3
...
.LC52:
	...
	.align	3
.LC53:
	.string	"Orig=Fence.idWR Fre Fence.idWR Fre\n"
	.align	3
.LC54:
	.string	"No"
	.align	3
...
.LC56:
	...
	.text
	.align	1
	.globl	SB_2B_fence_2E_is
	.type	SB_2B_fence_2E_is, @function
SB_2B_fence_2E_is:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	SB_2B_fence_2E_is, .-SB_2B_fence_2E_is
	.section	.rodata.str1.8
	.align	3
.LC57:
	.string	"[[0],[1]]"
