...
.L2:
	...
	.align	3
.LC1:
	.string	"SB+fence.rw.rws, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/SAFE/SB+fence.rw.rws.litmus %"
	.align	3
.LC10:
	.string	"RISCV SB+fence.rw.rws"
	.align	3
.LC11:
	.string	"\"Fence.rw.rwdWR Fre Fence.rw.rwdWR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
...
.LC24:
	...
	.align	3
.LC25:
	.string	"SB+fence.rw.rws: n=%i, r=%i, s=%i"
	.align	3
.LC26:
	.string	", st=%i"
	.align	3
...
.LC35:
	...
	.align	3
.LC36:
	.string	"SB+fence.rw.rws, sum_hist"
	.align	3
.LC37:
	.string	"Test SB+fence.rw.rws Allowed\n"
	.align	3
.LC38:
	.string	"Histogram (%d states)\n"
	.align	3
.LC39:
	.string	"Observation SB+fence.rw.rws %s %lu %lu\n"
	.align	3
.LC41:
	.string	"Time SB+fence.rw.rws %.2f\n"
	.align	3
.LC42:
	.string	"Ok"
	.align	3
...
.LC45:
	...
	.align	3
.LC46:
	.string	"Hash=aa9bc0b78dcbf8fc7bfb4591f327e832\n"
	.align	3
.LC47:
	.string	"Cycle=Fre Fence.rw.rwdWR Fre Fence.rw.rwdWR\n"
	.align	3
.LC48:
	.string	"Relax SB+fence.rw.rws %s %s\n"
	.align	3
.LC49:
...
.LC51:
	...
	.align	3
.LC52:
	.string	"Orig=Fence.rw.rwdWR Fre Fence.rw.rwdWR Fre\n"
	.align	3
.LC53:
	.string	"No"
	.align	3
...
.LC55:
	...
	.text
	.align	1
	.globl	SB_2B_fence_2E_rw_2E_rws
	.type	SB_2B_fence_2E_rw_2E_rws, @function
SB_2B_fence_2E_rw_2E_rws:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L215:
	call	__stack_chk_fail@plt
	.size	SB_2B_fence_2E_rw_2E_rws, .-SB_2B_fence_2E_rw_2E_rws
	.section	.rodata.str1.8
	.align	3
.LC56:
	.string	"[[0],[1]]"
