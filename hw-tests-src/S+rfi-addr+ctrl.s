...
.L2:
	...
	.align	3
.LC1:
	.string	"S+rfi-addr+ctrl, check_globals failed"
	.text
	.align	1
...
.LC4:
	...
	.align	3
.LC5:
	.string	"S+rfi-addr+ctrl, global x unstabilized"
	.text
	.align	1
	.type	zyva, @function
zyva:
...
.LC10:
	...
	.align	3
.LC11:
	.string	"% Results for tests/non-mixed-size/RELAX/Rfi/S+rfi-addr+ctrl.litmus %"
	.align	3
.LC12:
	.string	"RISCV S+rfi-addr+ctrl"
	.align	3
.LC13:
	.string	"\"Rfi DpAddrdW Rfe DpCtrldW Wse\""
	.align	3
.LC14:
	.string	"{"
	.align	3
...
.LC28:
	...
	.align	3
.LC29:
	.string	"S+rfi-addr+ctrl: n=%i, r=%i, s=%i"
	.align	3
.LC30:
	.string	", st=%i"
	.align	3
...
.LC39:
	...
	.align	3
.LC40:
	.string	"S+rfi-addr+ctrl, sum_hist"
	.align	3
.LC41:
	.string	"Test S+rfi-addr+ctrl Allowed\n"
	.align	3
.LC42:
	.string	"Histogram (%d states)\n"
	.align	3
.LC43:
	.string	"Observation S+rfi-addr+ctrl %s %lu %lu\n"
	.align	3
.LC45:
	.string	"Time S+rfi-addr+ctrl %.2f\n"
	.align	3
.LC46:
	.string	"Ok"
	.align	3
...
.LC49:
	...
	.align	3
.LC50:
	.string	"Hash=80a6db528f28954fd1b350a6ef84a5c3\n"
	.align	3
.LC51:
	.string	"Cycle=Rfi DpAddrdW Rfe DpCtrldW Wse\n"
	.align	3
.LC52:
	.string	"Rfi"
	.align	3
.LC53:
	.string	"Relax S+rfi-addr+ctrl %s %s\n"
	.align	3
.LC54:
...
.LC56:
	...
	.align	3
.LC57:
	.string	"Orig=Rfi DpAddrdW Rfe DpCtrldW Wse\n"
	.align	3
.LC58:
	.string	"No"
	.align	3
...
.LC60:
	...
	.text
	.align	1
	.globl	S_2B_rfi_2D_addr_2B_ctrl
	.type	S_2B_rfi_2D_addr_2B_ctrl, @function
S_2B_rfi_2D_addr_2B_ctrl:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
	sd	s2,480(sp)
...
.L235:
	call	__stack_chk_fail@plt
	.size	S_2B_rfi_2D_addr_2B_ctrl, .-S_2B_rfi_2D_addr_2B_ctrl
	.section	.rodata.str1.8
	.align	3
.LC61:
	.string	"[[0],[1]]"
