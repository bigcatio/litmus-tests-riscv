...
.L2:
	...
	.align	3
.LC1:
	.string	"SB+po-addrs, check_globals failed"
	.text
	.align	1
...
.LC8:
	...
	.align	3
.LC9:
	.string	"% Results for tests/non-mixed-size/RELAX/PodWR/SB+po-addrs.litmus %"
	.align	3
.LC10:
	.string	"RISCV SB+po-addrs"
	.align	3
.LC11:
	.string	"\"PodWR DpAddrdR Fre PodWR DpAddrdR Fre\""
	.align	3
.LC12:
	.string	"{"
	.align	3
.LC13:
	...
	.align	3
.LC14:
	.string	" 1:x5=1; 1:x6=z; 1:x8=a; 1:x11=x;"
	.align	3
.LC15:
	.string	"}"
	.align	3
...
.LC26:
	...
	.align	3
.LC27:
	.string	"SB+po-addrs: n=%i, r=%i, s=%i"
	.align	3
.LC28:
	.string	", st=%i"
	.align	3
...
.LC37:
	...
	.align	3
.LC38:
	.string	"SB+po-addrs, sum_hist"
	.align	3
.LC39:
	.string	"Test SB+po-addrs Allowed\n"
	.align	3
.LC40:
	.string	"Histogram (%d states)\n"
	.align	3
.LC41:
	.string	"Observation SB+po-addrs %s %lu %lu\n"
	.align	3
.LC43:
	.string	"Time SB+po-addrs %.2f\n"
	.align	3
.LC44:
	.string	"Ok"
	.align	3
...
.LC47:
	...
	.align	3
.LC48:
	.string	"Hash=63365e9c2bc623e1bc67d6db3b0079c9\n"
	.align	3
.LC49:
	.string	"Cycle=Fre PodWR DpAddrdR Fre PodWR DpAddrdR\n"
	.align	3
.LC50:
	.string	"PodWR"
	.align	3
.LC51:
	.string	"Relax SB+po-addrs %s %s\n"
	.align	3
.LC52:
...
.LC54:
	...
	.align	3
.LC55:
	.string	"Orig=PodWR DpAddrdR Fre PodWR DpAddrdR Fre\n"
	.align	3
.LC56:
	.string	"No"
	.align	3
...
.LC58:
	...
	.text
	.align	1
	.globl	SB_2B_po_2D_addrs
	.type	SB_2B_po_2D_addrs, @function
SB_2B_po_2D_addrs:
	addi	sp,sp,-512
	sd	s0,496(sp)
	sd	s1,488(sp)
...
.L230:
	call	__stack_chk_fail@plt
	.size	SB_2B_po_2D_addrs, .-SB_2B_po_2D_addrs
	.section	.rodata.str1.8
	.align	3
.LC59:
	.string	"[[0],[1]]"
